...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SandboxCollectionBody :  IEquatable<SandboxCollectionBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SandboxCollectionBody" /> class.
        /// </summary>
        ...
        /// <param name="collectionType">Collection type(MORE,CORRECT,LESS,INFINITE).</param>
        /// <param name="bank">Bank.</param>
        public SandboxCollectionBody(string requestId = default(string), string requestTime = default(string), string partnerCode = default(string), decimal? operation = default(decimal?), string accNo = default(string), string accName = default(string), decimal? collectAmount = default(decimal?), string orderId = default(string), string expireDate = default(string), string collectionType = default(string), string bank = default(string))
        {
        ...
        /// </summary>
        /// <value>Collection type(MORE,CORRECT,LESS,INFINITE)</value>
        ...
        {
            return this.Equals(input as SandboxCollectionBody);
        }

        /// <summary>
        /// Returns true if SandboxCollectionBody instances are equal
        /// </summary>
        /// <param name="input">Instance of SandboxCollectionBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SandboxCollectionBody input)
        {
            if (input == null)
                return false;
