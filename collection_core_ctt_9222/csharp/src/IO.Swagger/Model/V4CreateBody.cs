...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class V4CreateBody :  IEquatable<V4CreateBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V4CreateBody" /> class.
        /// </summary>
        ...
        public V4CreateBody(string requestId = default(string), string requestTime = default(string), string partnerCode = default(string), string accName = default(string), decimal? collectAmount = default(decimal?), string orderId = default(string), string expireDate = default(string), string bank = default(string))
        {
        ...
        {
            return this.Equals(input as V4CreateBody);
        }

        /// <summary>
        /// Returns true if V4CreateBody instances are equal
        /// </summary>
        /// <param name="input">Instance of V4CreateBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V4CreateBody input)
        {
            if (input == null)
                return false;
