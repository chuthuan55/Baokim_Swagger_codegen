...
/**
 * VirtualAccountVersion23Api Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VirtualAccountVersion23Api
{
    /**
     * @var ClientInterface
     */
     ...
     * create & update va
     *
     * @param  \Swagger\Client\Model\SandboxCollectionBody $body body (required)
     ...
     * create & update va
     *
     * @param  \Swagger\Client\Model\SandboxCollectionBody $body (required)
    ...
    protected function 6ce3bcd0268f76548ace52ed5eeeefefRequest($body, $content_type = null, $signature = null)
    {
        ...
        $resourcePath = '/api/Sandbox/Collection';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
