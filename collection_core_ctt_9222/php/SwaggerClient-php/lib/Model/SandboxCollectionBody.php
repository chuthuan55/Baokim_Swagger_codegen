...
/**
 * SandboxCollectionBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SandboxCollectionBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Sandbox_Collection_body';
...
'bank' => 'getBank'    ];
     ...
     * Sets acc_no
     *
     * @param string $acc_no Required when update:VA number need to update information
     *
     * @return $this
     */
     ...
     *
     * @param string $collection_type Collection type(MORE,CORRECT,LESS,INFINITE)
     *
     * @return $this
     */
