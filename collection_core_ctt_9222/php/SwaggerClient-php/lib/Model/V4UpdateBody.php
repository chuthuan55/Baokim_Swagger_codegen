...
/**
 * V4UpdateBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V4UpdateBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'V4_update_body';
...
'bank' => 'getBank'    ];
     ...
     * Sets bank
     *
     * @param string $bank Bank: VPBANK,BIDV,MSB,WOORIBANK
     *
     * @return $this
     */
