...
------------ | ------------- | ------------- | -------------
*VIRTUALACCOUNTApi* | [**6ce3bcd0268f76548ace52ed5eeeefef**](docs/Api/VIRTUALACCOUNTApi.md#6ce3bcd0268f76548ace52ed5eeeefef) | **POST** /Sandbox/Collection/V2 | create &amp; update va

## Documentation For Models

 - [CollectionV2Body](docs/Model/CollectionV2Body.md)
