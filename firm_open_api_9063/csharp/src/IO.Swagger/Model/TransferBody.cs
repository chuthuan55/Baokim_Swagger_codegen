...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TransferBody :  IEquatable<TransferBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferBody" /> class.
        /// </summary>
        /// <param name="requestId">The only code that corresponds to an upload request. Proposed format is as follows: PartnerCode + BK + YYYYMMDD + UniqueId.</param>
        /// <param name="requestTime">It is time to send request from Partner, format: YYYY-MM-DD HH:MM:SS.</param>
        /// <param name="partnerCode">The partner code is defined in the Baokim system. This code will send to the partner when the integration begins..</param>
        /// <param name="operation">This parameter will determine which function partner is calling. For the transfer function, the fix is “9002”.</param>
        /// <param name="referenceId">Transaction code sent by the partner.</param>
        /// <param name="bankNo">Bank code in accordance with Baokim is defined in the section 8. List of remittance banks.</param>
        /// <param name="accNo">Account number or bank card number of the customer..</param>
        /// <param name="accType">AccNo classification 0: Bank account number 1: Bank card number.</param>
        /// <param name="requestAmount">The amount requested by the partner to transfer to the recipient..</param>
        /// <param name="memo">Money transfer contents.</param>
        /// <param name="signature">The partner will sign with digital signature of data transmitted using the algorithm RSACryptoServiceProvider. Before sending ,data will be base64 encoding. Data follow this structure: RequestId|RequestTime|PartnerCode| Operation|ReferenceId|BankNo|AccNo| AccType|RequestAmount|Memo.</param>
        public TransferBody(string requestId = default(string), string requestTime = default(string), string partnerCode = default(string), string operation = default(string), string referenceId = default(string), string bankNo = default(string), string accNo = default(string), string accType = default(string), string requestAmount = default(string), string memo = default(string), string signature = default(string))
        {
        ...
        /// </summary>
        /// <value>The only code that corresponds to an upload request. Proposed format is as follows: PartnerCode + BK + YYYYMMDD + UniqueId</value>
        ...
        /// </summary>
        /// <value>It is time to send request from Partner, format: YYYY-MM-DD HH:MM:SS</value>
        ...
        /// </summary>
        /// <value>The partner code is defined in the Baokim system. This code will send to the partner when the integration begins.</value>
        ...
        /// </summary>
        /// <value>This parameter will determine which function partner is calling. For the transfer function, the fix is “9002”</value>
        ...
        /// </summary>
        /// <value>Transaction code sent by the partner</value>
        ...
        /// </summary>
        /// <value>Bank code in accordance with Baokim is defined in the section 8. List of remittance banks</value>
        ...
        /// </summary>
        /// <value>Account number or bank card number of the customer.</value>
        [DataMember(Name="AccNo", EmitDefaultValue=false)]
        public string AccNo { get; set; }

        /// <summary>
        /// AccNo classification 0: Bank account number 1: Bank card number
        /// </summary>
        /// <value>AccNo classification 0: Bank account number 1: Bank card number</value>
        ...
        /// </summary>
        /// <value>The amount requested by the partner to transfer to the recipient.</value>
        ...
        /// </summary>
        /// <value>Money transfer contents</value>
        [DataMember(Name="Memo", EmitDefaultValue=false)]
        public string Memo { get; set; }

        /// <summary>
        /// The partner will sign with digital signature of data transmitted using the algorithm RSACryptoServiceProvider. Before sending ,data will be base64 encoding. Data follow this structure: RequestId|RequestTime|PartnerCode| Operation|ReferenceId|BankNo|AccNo| AccType|RequestAmount|Memo
        /// </summary>
        /// <value>The partner will sign with digital signature of data transmitted using the algorithm RSACryptoServiceProvider. Before sending ,data will be base64 encoding. Data follow this structure: RequestId|RequestTime|PartnerCode| Operation|ReferenceId|BankNo|AccNo| AccType|RequestAmount|Memo</value>
        ...
        {
            return this.Equals(input as TransferBody);
        }

        /// <summary>
        /// Returns true if TransferBody instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferBody input)
        {
            if (input == null)
                return false;
