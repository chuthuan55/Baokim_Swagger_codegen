...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class VerifyBody :  IEquatable<VerifyBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VerifyBody" /> class.
        /// </summary>
        ...
        /// <param name="operation">This parameter will determine which function that partner is calling. For customer authentication functions, the fix is “9001”.</param>
        ...
        /// <param name="signature">The partner will sign with digital signature of data transmitted using the algorithm RSACryptoServiceProvider. Before sending ,data will be base64 encoding. Data follow this structure: RequestId|RequestTime| PartnerCode|Operation|BankNo| AccNo|AccType.</param>
        public VerifyBody(string requestId = default(string), string requestTime = default(string), string partnerCode = default(string), string operation = default(string), string bankNo = default(string), string accNo = default(string), string accType = default(string), string signature = default(string))
        {
        ...
        /// </summary>
        /// <value>This parameter will determine which function that partner is calling. For customer authentication functions, the fix is “9001”</value>
        ...
        /// <summary>
        /// The partner will sign with digital signature of data transmitted using the algorithm RSACryptoServiceProvider. Before sending ,data will be base64 encoding. Data follow this structure: RequestId|RequestTime| PartnerCode|Operation|BankNo| AccNo|AccType
        /// </summary>
        /// <value>The partner will sign with digital signature of data transmitted using the algorithm RSACryptoServiceProvider. Before sending ,data will be base64 encoding. Data follow this structure: RequestId|RequestTime| PartnerCode|Operation|BankNo| AccNo|AccType</value>
        ...
        {
            return this.Equals(input as VerifyBody);
        }

        /// <summary>
        /// Returns true if VerifyBody instances are equal
        /// </summary>
        /// <param name="input">Instance of VerifyBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VerifyBody input)
        {
            if (input == null)
                return false;
