...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LookupTransferBody :  IEquatable<LookupTransferBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LookupTransferBody" /> class.
        /// </summary>
        ...
        /// <param name="operation">This parameter will determine which function partner is calling. For transactional lookup information, the fix is \&quot;9003.</param>
        /// <param name="referenceId">Transaction code from PARTNER submitted.</param>
        /// <param name="signature">The partner will digitally sign up data using the RSACryptoServiceProvider algorithm. Before sending to will base64 encoding. Data is structured: RequestId|RequestTime|PartnerCode| Operation|ReferenceId.</param>
        public LookupTransferBody(string requestId = default(string), string requestTime = default(string), string partnerCode = default(string), string operation = default(string), string referenceId = default(string), string signature = default(string))
        {
        ...
        /// </summary>
        /// <value>This parameter will determine which function partner is calling. For transactional lookup information, the fix is \&quot;9003</value>
        ...
        /// </summary>
        /// <value>Transaction code from PARTNER submitted</value>
        [DataMember(Name="ReferenceId", EmitDefaultValue=false)]
        public string ReferenceId { get; set; }

        /// <summary>
        /// The partner will digitally sign up data using the RSACryptoServiceProvider algorithm. Before sending to will base64 encoding. Data is structured: RequestId|RequestTime|PartnerCode| Operation|ReferenceId
        /// </summary>
        /// <value>The partner will digitally sign up data using the RSACryptoServiceProvider algorithm. Before sending to will base64 encoding. Data is structured: RequestId|RequestTime|PartnerCode| Operation|ReferenceId</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LookupTransferBody {\n");
        ...
        {
            return this.Equals(input as LookupTransferBody);
        }

        /// <summary>
        /// Returns true if LookupTransferBody instances are equal
        /// </summary>
        /// <param name="input">Instance of LookupTransferBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LookupTransferBody input)
        {
            if (input == null)
                return false;
