...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse200 :  IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        /// <param name="requestId">Partner information posted.</param>
        ...
        /// <param name="accName">Baokim Customer&#x27;s name response if customer information is submitted correctly.</param>
        /// <param name="signature">Baokim will sign with digital signature of data returned using RSACryptoServiceProvider. Returns the base64 encoding. Data is structured: ResponseCode|ResponseMessage|RequestId| BankNo|AccNo|AccType|AccName.</param>
        public InlineResponse200(int? responseCode = default(int?), string responseMessage = default(string), string requestId = default(string), string bankNo = default(string), string accNo = default(string), string accType = default(string), string accName = default(string), string signature = default(string))
        {
        ...
        /// </summary>
        /// <value>Baokim Customer&#x27;s name response if customer information is submitted correctly</value>
        ...
        /// </summary>
        /// <value>Baokim will sign with digital signature of data returned using RSACryptoServiceProvider. Returns the base64 encoding. Data is structured: ResponseCode|ResponseMessage|RequestId| BankNo|AccNo|AccType|AccName</value>
