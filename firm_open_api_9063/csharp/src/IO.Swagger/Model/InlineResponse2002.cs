...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2002 :  IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        /// <param name="referenceId">This is the ReferenceID of the input parameter.</param>
        ...
        /// <param name="signature">BAOKIM will sign by digital signature of response data. Data is structured: ResponseCode| ResponseMessage| ReferenceId|TransactionId| TransactionTime|BankNo|AccNo|AccName|AccType| RequestAmount|TransferAmount.</param>
        public InlineResponse2002(int? responseCode = default(int?), string responseMessage = default(string), string referenceId = default(string), string transactionId = default(string), string transactionTime = default(string), string bankNo = default(string), string accNo = default(string), string accType = default(string), string accName = default(string), int? requestAmount = default(int?), int? transferAmount = default(int?), string signature = default(string))
        {
        ...
        /// </summary>
        /// <value>This is the ReferenceID of the input parameter</value>
        ...
        /// </summary>
        /// <value>BAOKIM will sign by digital signature of response data. Data is structured: ResponseCode| ResponseMessage| ReferenceId|TransactionId| TransactionTime|BankNo|AccNo|AccName|AccType| RequestAmount|TransferAmount</value>
