...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
        public interface ITransferMoneyApi : IApiAccessor
    {
...
2. If the correct information will return successful transfer. 
 ...
 Note(*) : If the transaction is pending, the Partner must wait for the final result from Baokim by calling the &lt;a href&#x3D;&#x27;/baokim-firm-open-api-9003&#x27;&gt; Function look up for transfer info &lt;/a&gt;. (optional)</param>
...
2. If the correct information will return successful transfer. 
 ...
 Note(*) : If the transaction is pending, the Partner must wait for the final result from Baokim by calling the &lt;a href&#x3D;&#x27;/baokim-firm-open-api-9003&#x27;&gt; Function look up for transfer info &lt;/a&gt;. (optional)</param>
        ...
        ApiResponse<InlineResponse2001> TransferPostWithHttpInfo (TransferBody body = null);
...
2. If the correct information will return successful transfer. 
 ...
 Note(*) : If the transaction is pending, the Partner must wait for the final result from Baokim by calling the &lt;a href&#x3D;&#x27;/baokim-firm-open-api-9003&#x27;&gt; Function look up for transfer info &lt;/a&gt;. (optional)</param>
        ...
        System.Threading.Tasks.Task<InlineResponse2001> TransferPostAsync (TransferBody body = null);
...
2. If the correct information will return successful transfer. 
 ...
 Note(*) : If the transaction is pending, the Partner must wait for the final result from Baokim by calling the &lt;a href&#x3D;&#x27;/baokim-firm-open-api-9003&#x27;&gt; Function look up for transfer info &lt;/a&gt;. (optional)</param>
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2001>> TransferPostAsyncWithHttpInfo (TransferBody body = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class TransferMoneyApi : ITransferMoneyApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="TransferMoneyApi"/> class.
        /// </summary>
        /// <returns></returns>
        public TransferMoneyApi(String basePath)
        {
        ...
        /// <returns></returns>
        public TransferMoneyApi(IO.Swagger.Client.Configuration configuration = null)
        {
...
2. If the correct information will return successful transfer. 
 ...
 Note(*) : If the transaction is pending, the Partner must wait for the final result from Baokim by calling the &lt;a href&#x3D;&#x27;/baokim-firm-open-api-9003&#x27;&gt; Function look up for transfer info &lt;/a&gt;. (optional)</param>
        /// <returns>InlineResponse2001</returns>
        public InlineResponse2001 TransferPost (TransferBody body = null)
        {
             ApiResponse<InlineResponse2001> localVarResponse = TransferPostWithHttpInfo(body);
...
2. If the correct information will return successful transfer. 
 ...
 Note(*) : If the transaction is pending, the Partner must wait for the final result from Baokim by calling the &lt;a href&#x3D;&#x27;/baokim-firm-open-api-9003&#x27;&gt; Function look up for transfer info &lt;/a&gt;. (optional)</param>
        /// <returns>ApiResponse of InlineResponse2001</returns>
        public ApiResponse< InlineResponse2001 > TransferPostWithHttpInfo (TransferBody body = null)
        {

            var localVarPath = "/Transfer";
            ...
            {
                Exception exception = ExceptionFactory("TransferPost", localVarResponse);
...
2. If the correct information will return successful transfer. 
 ...
 Note(*) : If the transaction is pending, the Partner must wait for the final result from Baokim by calling the &lt;a href&#x3D;&#x27;/baokim-firm-open-api-9003&#x27;&gt; Function look up for transfer info &lt;/a&gt;. (optional)</param>
        /// <returns>Task of InlineResponse2001</returns>
        public async System.Threading.Tasks.Task<InlineResponse2001> TransferPostAsync (TransferBody body = null)
        {
             ApiResponse<InlineResponse2001> localVarResponse = await TransferPostAsyncWithHttpInfo(body);
             return localVarResponse.Data;
...
2. If the correct information will return successful transfer. 
 ...
 Note(*) : If the transaction is pending, the Partner must wait for the final result from Baokim by calling the &lt;a href&#x3D;&#x27;/baokim-firm-open-api-9003&#x27;&gt; Function look up for transfer info &lt;/a&gt;. (optional)</param>
        /// <returns>Task of ApiResponse (InlineResponse2001)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse2001>> TransferPostAsyncWithHttpInfo (TransferBody body = null)
        {
