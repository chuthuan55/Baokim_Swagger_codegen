...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
        public interface ILookUpForTransferInfoApi : IApiAccessor
    {
...
2. If the information is correct, return the transaction information.. (optional)</param>
...
2. If the information is correct, return the transaction information.. (optional)</param>
        ...
        ApiResponse<InlineResponse2002> LookupTransferPostWithHttpInfo (LookupTransferBody body = null);
...
2. If the information is correct, return the transaction information.. (optional)</param>
        ...
        System.Threading.Tasks.Task<InlineResponse2002> LookupTransferPostAsync (LookupTransferBody body = null);
...
2. If the information is correct, return the transaction information.. (optional)</param>
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2002>> LookupTransferPostAsyncWithHttpInfo (LookupTransferBody body = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class LookUpForTransferInfoApi : ILookUpForTransferInfoApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="LookUpForTransferInfoApi"/> class.
        /// </summary>
        /// <returns></returns>
        public LookUpForTransferInfoApi(String basePath)
        {
        ...
        /// <returns></returns>
        public LookUpForTransferInfoApi(IO.Swagger.Client.Configuration configuration = null)
        {
...
2. If the information is correct, return the transaction information.. (optional)</param>
        /// <returns>InlineResponse2002</returns>
        public InlineResponse2002 LookupTransferPost (LookupTransferBody body = null)
        {
             ApiResponse<InlineResponse2002> localVarResponse = LookupTransferPostWithHttpInfo(body);
...
2. If the information is correct, return the transaction information.. (optional)</param>
        /// <returns>ApiResponse of InlineResponse2002</returns>
        public ApiResponse< InlineResponse2002 > LookupTransferPostWithHttpInfo (LookupTransferBody body = null)
        {

            var localVarPath = "/LookupTransfer";
            ...
            {
                Exception exception = ExceptionFactory("LookupTransferPost", localVarResponse);
...
2. If the information is correct, return the transaction information.. (optional)</param>
        /// <returns>Task of InlineResponse2002</returns>
        public async System.Threading.Tasks.Task<InlineResponse2002> LookupTransferPostAsync (LookupTransferBody body = null)
        {
             ApiResponse<InlineResponse2002> localVarResponse = await LookupTransferPostAsyncWithHttpInfo(body);
             return localVarResponse.Data;
...
2. If the information is correct, return the transaction information.. (optional)</param>
        /// <returns>Task of ApiResponse (InlineResponse2002)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse2002>> LookupTransferPostAsyncWithHttpInfo (LookupTransferBody body = null)
        {
