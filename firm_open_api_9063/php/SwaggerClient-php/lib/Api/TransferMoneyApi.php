...
/**
 * TransferMoneyApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class TransferMoneyApi
{
    ...
    /**
     * Operation transferPost
     *
     * https::devtest.baokim.vn/Sandbox/FirmBanking
     *
     * @param  \Swagger\Client\Model\TransferBody $body Process:
...
2. If the correct information will return successful transfer. 
 ...
 Note(*) : If the transaction is pending, the Partner must wait for the final result from Baokim by calling the &lt;a href&#x3D;&#x27;/baokim-firm-open-api-9003&#x27;&gt; Function look up for transfer info &lt;/a&gt;. (optional)
     ...
     */
    public function transferPost($body = null)
    {
        list($response) = $this->transferPostWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation transferPostWithHttpInfo
     *
     * https::devtest.baokim.vn/Sandbox/FirmBanking
     *
     * @param  \Swagger\Client\Model\TransferBody $body Process:
...
2. If the correct information will return successful transfer. 
 ...
 Note(*) : If the transaction is pending, the Partner must wait for the final result from Baokim by calling the &lt;a href&#x3D;&#x27;/baokim-firm-open-api-9003&#x27;&gt; Function look up for transfer info &lt;/a&gt;. (optional)
     ...
     */
    public function transferPostWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2001';
        $request = $this->transferPostRequest($body);
...
2. If the correct information will return successful transfer. 
 ...
 Note(*) : If the transaction is pending, the Partner must wait for the final result from Baokim by calling the &lt;a href&#x3D;&#x27;/baokim-firm-open-api-9003&#x27;&gt; Function look up for transfer info &lt;/a&gt;. (optional)
     ...
     */
    public function transferPostAsync($body = null)
    {
        return $this->transferPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation transferPostAsyncWithHttpInfo
     *
     * https::devtest.baokim.vn/Sandbox/FirmBanking
     *
     * @param  \Swagger\Client\Model\TransferBody $body Process:
...
2. If the correct information will return successful transfer. 
 ...
 Note(*) : If the transaction is pending, the Partner must wait for the final result from Baokim by calling the &lt;a href&#x3D;&#x27;/baokim-firm-open-api-9003&#x27;&gt; Function look up for transfer info &lt;/a&gt;. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function transferPostAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2001';
        $request = $this->transferPostRequest($body);
    ...
    /**
     * Create request for operation 'transferPost'
     *
     * @param  \Swagger\Client\Model\TransferBody $body Process:
...
2. If the correct information will return successful transfer. 
 ...
 Note(*) : If the transaction is pending, the Partner must wait for the final result from Baokim by calling the &lt;a href&#x3D;&#x27;/baokim-firm-open-api-9003&#x27;&gt; Function look up for transfer info &lt;/a&gt;. (optional)
     ...
     */
    protected function transferPostRequest($body = null)
    {
