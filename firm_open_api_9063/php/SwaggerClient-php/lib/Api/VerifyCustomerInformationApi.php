...
/**
 * VerifyCustomerInformationApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VerifyCustomerInformationApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation verifyPost
     *
     * https::devtest.baokim.vn/Sandbox/FirmBanking
     *
     * @param  \Swagger\Client\Model\VerifyBody $body 1. Partner will call the customer authentication function, Baokim will check the data format and signature authentication..
...
3. If the information is correct, Baokim will return successful information and corresponding customer name. (optional)
     ...
     */
    public function verifyPost($body = null)
    {
        list($response) = $this->verifyPostWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation verifyPostWithHttpInfo
     *
     * https::devtest.baokim.vn/Sandbox/FirmBanking
     *
     * @param  \Swagger\Client\Model\VerifyBody $body 1. Partner will call the customer authentication function, Baokim will check the data format and signature authentication..
...
3. If the information is correct, Baokim will return successful information and corresponding customer name. (optional)
     ...
     */
    public function verifyPostWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->verifyPostRequest($body);
...
3. If the information is correct, Baokim will return successful information and corresponding customer name. (optional)
     ...
     */
    public function verifyPostAsync($body = null)
    {
        return $this->verifyPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation verifyPostAsyncWithHttpInfo
     *
     * https::devtest.baokim.vn/Sandbox/FirmBanking
     *
     * @param  \Swagger\Client\Model\VerifyBody $body 1. Partner will call the customer authentication function, Baokim will check the data format and signature authentication..
...
3. If the information is correct, Baokim will return successful information and corresponding customer name. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function verifyPostAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->verifyPostRequest($body);
    ...
    /**
     * Create request for operation 'verifyPost'
     *
     * @param  \Swagger\Client\Model\VerifyBody $body 1. Partner will call the customer authentication function, Baokim will check the data format and signature authentication..
...
3. If the information is correct, Baokim will return successful information and corresponding customer name. (optional)
     ...
     */
    protected function verifyPostRequest($body = null)
    {
