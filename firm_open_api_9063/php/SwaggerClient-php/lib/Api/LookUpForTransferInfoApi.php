...
/**
 * LookUpForTransferInfoApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LookUpForTransferInfoApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation lookupTransferPost
     *
     * https::devtest.baokim.vn/Sandbox/FirmBanking
     *
     * @param  \Swagger\Client\Model\LookupTransferBody $body Process:
...
2. If the information is correct, return the transaction information.. (optional)
     ...
     */
    public function lookupTransferPost($body = null)
    {
        list($response) = $this->lookupTransferPostWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation lookupTransferPostWithHttpInfo
     *
     * https::devtest.baokim.vn/Sandbox/FirmBanking
     *
     * @param  \Swagger\Client\Model\LookupTransferBody $body Process:
...
2. If the information is correct, return the transaction information.. (optional)
     ...
     */
    public function lookupTransferPostWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2002';
        $request = $this->lookupTransferPostRequest($body);
    ...
    /**
     * Operation lookupTransferPostAsync
     *
     * https::devtest.baokim.vn/Sandbox/FirmBanking
     *
     * @param  \Swagger\Client\Model\LookupTransferBody $body Process:
...
2. If the information is correct, return the transaction information.. (optional)
     ...
     */
    public function lookupTransferPostAsync($body = null)
    {
        return $this->lookupTransferPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation lookupTransferPostAsyncWithHttpInfo
     *
     * https::devtest.baokim.vn/Sandbox/FirmBanking
     *
     * @param  \Swagger\Client\Model\LookupTransferBody $body Process:
...
2. If the information is correct, return the transaction information.. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function lookupTransferPostAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2002';
        $request = $this->lookupTransferPostRequest($body);
    ...
    /**
     * Create request for operation 'lookupTransferPost'
     *
     * @param  \Swagger\Client\Model\LookupTransferBody $body Process:
...
2. If the information is correct, return the transaction information.. (optional)
     ...
     */
    protected function lookupTransferPostRequest($body = null)
    {

        $resourcePath = '/LookupTransfer';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
