 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VerifyBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Verify_body';
...
'signature' => 'getSignature'    ];
     ...
     * Sets operation
     *
     * @param string $operation This parameter will determine which function that partner is calling. For customer authentication functions, the fix is “9001”
     *
     * @return $this
     */
     ...
     * Sets signature
     *
     * @param string $signature The partner will sign with digital signature of data transmitted using the algorithm RSACryptoServiceProvider. Before sending ,data will be base64 encoding. Data follow this structure: RequestId|RequestTime| PartnerCode|Operation|BankNo| AccNo|AccType
     *
     * @return $this
     */
