...
/**
 * TransferBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransferBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Transfer_body';
...
'signature' => 'getSignature'    ];
     ...
     * Sets request_id
     *
     * @param string $request_id The only code that corresponds to an upload request. Proposed format is as follows: PartnerCode + BK + YYYYMMDD + UniqueId
     *
     * @return $this
     */
     ...
     * Sets request_time
     *
     * @param string $request_time It is time to send request from Partner, format: YYYY-MM-DD HH:MM:SS
     *
     * @return $this
     */
     ...
     * Sets partner_code
     *
     * @param string $partner_code The partner code is defined in the Baokim system. This code will send to the partner when the integration begins.
     *
     * @return $this
     */
     ...
     * Sets operation
     *
     * @param string $operation This parameter will determine which function partner is calling. For the transfer function, the fix is “9002”
     *
     * @return $this
     */
     ...
     * Sets reference_id
     *
     * @param string $reference_id Transaction code sent by the partner
     *
     * @return $this
     */
     ...
     * Sets bank_no
     *
     * @param string $bank_no Bank code in accordance with Baokim is defined in the section 8. List of remittance banks
     *
     * @return $this
     */
     ...
     * Sets acc_no
     *
     * @param string $acc_no Account number or bank card number of the customer.
     *
     * @return $this
     */
     ...
     * Sets acc_type
     *
     * @param string $acc_type AccNo classification 0: Bank account number 1: Bank card number
     *
     * @return $this
     */
     ...
     * Sets request_amount
     *
     * @param string $request_amount The amount requested by the partner to transfer to the recipient.
     *
     * @return $this
     */
     ...
     * Sets signature
     *
     * @param string $signature The partner will sign with digital signature of data transmitted using the algorithm RSACryptoServiceProvider. Before sending ,data will be base64 encoding. Data follow this structure: RequestId|RequestTime|PartnerCode| Operation|ReferenceId|BankNo|AccNo| AccType|RequestAmount|Memo
     *
     * @return $this
     */
