...
/**
 * LookupBalanceBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LookupBalanceBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LookupBalance_body';
...
'signature' => 'getSignature'    ];
     ...
     * Sets operation
     *
     * @param string $operation This parameter will determine which function partner is calling. For lookup balance information, the fix is (9004)
     *
     * @return $this
     */
     ...
     * Sets signature
     *
     * @param string $signature The partner will digitally sign up data using the RSACryptoServiceProvider algorithm. Before sending to will base64 encoding. Data is structured: RequestId|RequestTime| PartnerCode|Operation
     *
     * @return $this
     */
