...
/**
 * LookupTransferBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LookupTransferBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LookupTransfer_body';
...
'signature' => 'getSignature'    ];
     ...
     * Sets operation
     *
     * @param string $operation This parameter will determine which function partner is calling. For transactional lookup information, the fix is \"9003
     *
     * @return $this
     */
     ...
     * Sets reference_id
     *
     * @param string $reference_id Transaction code from PARTNER submitted
     *
     * @return $this
     */
     ...
     * Sets signature
     *
     * @param string $signature The partner will digitally sign up data using the RSACryptoServiceProvider algorithm. Before sending to will base64 encoding. Data is structured: RequestId|RequestTime|PartnerCode| Operation|ReferenceId
     *
     * @return $this
     */
