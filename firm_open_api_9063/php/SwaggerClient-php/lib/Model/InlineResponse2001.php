...
'affter_balance' => 'setAffterBalance',
'after_disbursement_day' => 'setAfterDisbursementDay',
...
'affter_balance' => 'getAffterBalance',
'after_disbursement_day' => 'getAfterDisbursementDay',
'signature' => 'getSignature'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['bank_no'] = isset($data['bank_no']) ? $data['bank_no'] : null;
        ...
        $this->container['request_amount'] = isset($data['request_amount']) ? $data['request_amount'] : null;
        $this->container['transfer_amount'] = isset($data['transfer_amount']) ? $data['transfer_amount'] : null;
        $this->container['affter_balance'] = isset($data['affter_balance']) ? $data['affter_balance'] : null;
        $this->container['after_disbursement_day'] = isset($data['after_disbursement_day']) ? $data['after_disbursement_day'] : null;
     ...
     *
     * @param string $response_message Description for return status
     *
     * @return $this
     */
     ...
     * Sets reference_id
     *
     * @param string $reference_id Partner information posted
     *
     * @return $this
     */
     ...
     * Sets transaction_id
     *
     * @param string $transaction_id Transaction code recorded side Baokim
     *
     * @return $this
     */
     ...
     *
     * @param string $transaction_time Finishing time side Baokim. Format YYYY-MM-DD
     *
     * @return $this
     */
    ...
    {
        return $this->container['bank_no'];
    }

    /**
     * Sets bank_no
     *
     * @param string $bank_no Partner information posted
     *
     * @return $this
     */
    public function setBankNo($bank_no)
    {
        $this->container['bank_no'] = $bank_no;
     ...
     * Sets acc_no
     *
     * @param string $acc_no Partner information posted
     *
     * @return $this
     */
     ...
     * Sets acc_name
     *
     * @param string $acc_name Full name of the recipient, may or may not, depending on the time
     *
     * @return $this
     */
     ...
     * Sets acc_type
     *
     * @param string $acc_type Partner information posted
     *
     * @return $this
     */
     ...
     * Sets request_amount
     *
     * @param int $request_amount Partner information posted
     *
     * @return $this
     */
     ...
     *
     * @param int $transfer_amount The actual amount transferred to the recipient. Will be less if the remittance
     *
     * @return $this
     */
     ...
     * @return int
     */
    public function getAffterBalance()
    {
        return $this->container['affter_balance'];
    }

    /**
     * Sets affter_balance
     *
     * @param int $affter_balance Current balance of investors
     *
     * @return $this
     */
    public function setAffterBalance($affter_balance)
    {
        $this->container['affter_balance'] = $affter_balance;

        return $this;
    }

    /**
     * Gets after_disbursement_day
     *
     * @return int
     */
    public function getAfterDisbursementDay()
    {
        return $this->container['after_disbursement_day'];
    }

    /**
     * Sets after_disbursement_day
     *
     * @param int $after_disbursement_day Continue disbursement amount (in limit)
     *
     * @return $this
     */
    public function setAfterDisbursementDay($after_disbursement_day)
    {
        $this->container['after_disbursement_day'] = $after_disbursement_day;
     ...
     * Sets signature
     *
     * @param string $signature BAOKIM will sign by digital signature of response data. Structured data: ResponseCode|ResponseMessage| RequestId | PartnerCode | Available | Holding
     *
     * @return $this
     */
