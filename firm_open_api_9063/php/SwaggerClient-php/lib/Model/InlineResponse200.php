...
'signature' => 'getSignature'    ];
     ...
     * Sets request_id
     *
     * @param string $request_id Partner information posted
     *
     * @return $this
     */
     ...
     * Sets acc_name
     *
     * @param string $acc_name Baokim Customer's name response if customer information is submitted correctly
     *
     * @return $this
     */
     ...
     * Sets signature
     *
     * @param string $signature Baokim will sign with digital signature of data returned using RSACryptoServiceProvider. Returns the base64 encoding. Data is structured: ResponseCode|ResponseMessage|RequestId| BankNo|AccNo|AccType|AccName
     *
     * @return $this
     */
