...
'signature' => 'getSignature'    ];
     ...
     *
     * @param string $response_message Description for response status
     *
     * @return $this
     */
     ...
     * Sets reference_id
     *
     * @param string $reference_id This is the ReferenceID of the input parameter
     *
     * @return $this
     */
     ...
     * Sets signature
     *
     * @param string $signature BAOKIM will sign by digital signature of response data. Data is structured: ResponseCode| ResponseMessage| ReferenceId|TransactionId| TransactionTime|BankNo|AccNo|AccName|AccType| RequestAmount|TransferAmount
     *
     * @return $this
     */
