...
class TransferBody(object):
    ...
    def __init__(self, request_id=None, request_time=None, partner_code=None, operation=None, reference_id=None, bank_no=None, acc_no=None, acc_type=None, request_amount=None, memo=None, signature=None):  # noqa: E501
        """TransferBody - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def request_id(self):
        """Gets the request_id of this TransferBody.  # noqa: E501

        The only code that corresponds to an upload request. Proposed format is as follows: PartnerCode + BK + YYYYMMDD + UniqueId  # noqa: E501

        :return: The request_id of this TransferBody.  # noqa: E501
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        """Sets the request_id of this TransferBody.

        The only code that corresponds to an upload request. Proposed format is as follows: PartnerCode + BK + YYYYMMDD + UniqueId  # noqa: E501

        :param request_id: The request_id of this TransferBody.  # noqa: E501
        :type: str
        """
    ...
    def request_time(self):
        """Gets the request_time of this TransferBody.  # noqa: E501

        It is time to send request from Partner, format: YYYY-MM-DD HH:MM:SS  # noqa: E501

        :return: The request_time of this TransferBody.  # noqa: E501
        :rtype: str
        """
    ...
    def request_time(self, request_time):
        """Sets the request_time of this TransferBody.

        It is time to send request from Partner, format: YYYY-MM-DD HH:MM:SS  # noqa: E501

        :param request_time: The request_time of this TransferBody.  # noqa: E501
        :type: str
        """
    ...
    def partner_code(self):
        """Gets the partner_code of this TransferBody.  # noqa: E501

        The partner code is defined in the Baokim system. This code will send to the partner when the integration begins.  # noqa: E501

        :return: The partner_code of this TransferBody.  # noqa: E501
        :rtype: str
        """
    ...
    def partner_code(self, partner_code):
        """Sets the partner_code of this TransferBody.

        The partner code is defined in the Baokim system. This code will send to the partner when the integration begins.  # noqa: E501

        :param partner_code: The partner_code of this TransferBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def operation(self):
        """Gets the operation of this TransferBody.  # noqa: E501

        This parameter will determine which function partner is calling. For the transfer function, the fix is “9002”  # noqa: E501

        :return: The operation of this TransferBody.  # noqa: E501
        :rtype: str
        """
    ...
    def operation(self, operation):
        """Sets the operation of this TransferBody.

        This parameter will determine which function partner is calling. For the transfer function, the fix is “9002”  # noqa: E501

        :param operation: The operation of this TransferBody.  # noqa: E501
        :type: str
        """
    ...
    def reference_id(self):
        """Gets the reference_id of this TransferBody.  # noqa: E501

        Transaction code sent by the partner  # noqa: E501

        :return: The reference_id of this TransferBody.  # noqa: E501
        :rtype: str
        """
    ...
    def reference_id(self, reference_id):
        """Sets the reference_id of this TransferBody.

        Transaction code sent by the partner  # noqa: E501

        :param reference_id: The reference_id of this TransferBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def bank_no(self):
        """Gets the bank_no of this TransferBody.  # noqa: E501

        Bank code in accordance with Baokim is defined in the section 8. List of remittance banks  # noqa: E501

        :return: The bank_no of this TransferBody.  # noqa: E501
        :rtype: str
        """
    ...
    def bank_no(self, bank_no):
        """Sets the bank_no of this TransferBody.

        Bank code in accordance with Baokim is defined in the section 8. List of remittance banks  # noqa: E501

        :param bank_no: The bank_no of this TransferBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def acc_no(self):
        """Gets the acc_no of this TransferBody.  # noqa: E501

        Account number or bank card number of the customer.  # noqa: E501

        :return: The acc_no of this TransferBody.  # noqa: E501
        :rtype: str
        """
        return self._acc_no
    ...
    def acc_no(self, acc_no):
        """Sets the acc_no of this TransferBody.

        Account number or bank card number of the customer.  # noqa: E501

        :param acc_no: The acc_no of this TransferBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def acc_type(self):
        """Gets the acc_type of this TransferBody.  # noqa: E501

        AccNo classification 0: Bank account number 1: Bank card number  # noqa: E501

        :return: The acc_type of this TransferBody.  # noqa: E501
        :rtype: str
        """
    ...
    def acc_type(self, acc_type):
        """Sets the acc_type of this TransferBody.

        AccNo classification 0: Bank account number 1: Bank card number  # noqa: E501

        :param acc_type: The acc_type of this TransferBody.  # noqa: E501
        :type: str
        """
    ...
    def request_amount(self):
        """Gets the request_amount of this TransferBody.  # noqa: E501

        The amount requested by the partner to transfer to the recipient.  # noqa: E501

        :return: The request_amount of this TransferBody.  # noqa: E501
        :rtype: str
        """
    ...
    def request_amount(self, request_amount):
        """Sets the request_amount of this TransferBody.

        The amount requested by the partner to transfer to the recipient.  # noqa: E501

        :param request_amount: The request_amount of this TransferBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def memo(self):
        """Gets the memo of this TransferBody.  # noqa: E501

        Money transfer contents  # noqa: E501

        :return: The memo of this TransferBody.  # noqa: E501
        :rtype: str
        """
        return self._memo
    ...
    @memo.setter
    def memo(self, memo):
        """Sets the memo of this TransferBody.

        Money transfer contents  # noqa: E501

        :param memo: The memo of this TransferBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def signature(self):
        """Gets the signature of this TransferBody.  # noqa: E501

        The partner will sign with digital signature of data transmitted using the algorithm RSACryptoServiceProvider. Before sending ,data will be base64 encoding. Data follow this structure: RequestId|RequestTime|PartnerCode| Operation|ReferenceId|BankNo|AccNo| AccType|RequestAmount|Memo  # noqa: E501

        :return: The signature of this TransferBody.  # noqa: E501
        :rtype: str
        """
    ...
    def signature(self, signature):
        """Sets the signature of this TransferBody.

        The partner will sign with digital signature of data transmitted using the algorithm RSACryptoServiceProvider. Before sending ,data will be base64 encoding. Data follow this structure: RequestId|RequestTime|PartnerCode| Operation|ReferenceId|BankNo|AccNo| AccType|RequestAmount|Memo  # noqa: E501

        :param signature: The signature of this TransferBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TransferBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TransferBody):
            return False
