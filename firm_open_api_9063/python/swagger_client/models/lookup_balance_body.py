...
class LookupBalanceBody(object):
    ...
    def __init__(self, request_id=None, request_time=None, partner_code=None, operation=None, signature=None):  # noqa: E501
        """LookupBalanceBody - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def request_id(self):
        """Gets the request_id of this LookupBalanceBody.  # noqa: E501
        ...
        :return: The request_id of this LookupBalanceBody.  # noqa: E501
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        """Sets the request_id of this LookupBalanceBody.

        The only code that corresponds to an upload request. Proposed format is as follows: PartnerCode + BK + YYYYMMDD + UniqueId  # noqa: E501

        :param request_id: The request_id of this LookupBalanceBody.  # noqa: E501
        :type: str
        """
    ...
    def request_time(self):
        """Gets the request_time of this LookupBalanceBody.  # noqa: E501

        It is time to send request from Partner, format: YYYY-MM-DD HH:MM:SS  # noqa: E501

        :return: The request_time of this LookupBalanceBody.  # noqa: E501
        :rtype: str
        """
    ...
    def request_time(self, request_time):
        """Sets the request_time of this LookupBalanceBody.

        It is time to send request from Partner, format: YYYY-MM-DD HH:MM:SS  # noqa: E501

        :param request_time: The request_time of this LookupBalanceBody.  # noqa: E501
        :type: str
        """
    ...
    def partner_code(self):
        """Gets the partner_code of this LookupBalanceBody.  # noqa: E501
        ...
        :return: The partner_code of this LookupBalanceBody.  # noqa: E501
        :rtype: str
        """
    ...
    def partner_code(self, partner_code):
        """Sets the partner_code of this LookupBalanceBody.

        The partner code is defined in the Baokim system. This code will send to the partner when the integration begins.  # noqa: E501

        :param partner_code: The partner_code of this LookupBalanceBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def operation(self):
        """Gets the operation of this LookupBalanceBody.  # noqa: E501

        This parameter will determine which function partner is calling. For lookup balance information, the fix is (9004)  # noqa: E501

        :return: The operation of this LookupBalanceBody.  # noqa: E501
        :rtype: str
        """
    ...
    def operation(self, operation):
        """Sets the operation of this LookupBalanceBody.

        This parameter will determine which function partner is calling. For lookup balance information, the fix is (9004)  # noqa: E501

        :param operation: The operation of this LookupBalanceBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def signature(self):
        """Gets the signature of this LookupBalanceBody.  # noqa: E501

        The partner will digitally sign up data using the RSACryptoServiceProvider algorithm. Before sending to will base64 encoding. Data is structured: RequestId|RequestTime| PartnerCode|Operation  # noqa: E501

        :return: The signature of this LookupBalanceBody.  # noqa: E501
        :rtype: str
        """
    ...
    def signature(self, signature):
        """Sets the signature of this LookupBalanceBody.

        The partner will digitally sign up data using the RSACryptoServiceProvider algorithm. Before sending to will base64 encoding. Data is structured: RequestId|RequestTime| PartnerCode|Operation  # noqa: E501

        :param signature: The signature of this LookupBalanceBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LookupBalanceBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LookupBalanceBody):
            return False
