...
class VerifyCustomerInformationApi(object):
    ...
    def verify_post(self, **kwargs):  # noqa: E501
        """https::devtest.baokim.vn/Sandbox/FirmBanking  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.verify_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param VerifyBody body: 1. Partner will call the customer authentication function, Baokim will check the data format and signature authentication..
...
3. If the information is correct, Baokim will return successful information and corresponding customer name.
        ...
        if kwargs.get('async_req'):
            return self.verify_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.verify_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def verify_post_with_http_info(self, **kwargs):  # noqa: E501
        """https::devtest.baokim.vn/Sandbox/FirmBanking  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.verify_post_with_http_info(async_req=True)
        >>> result = thread.get()
