...
class TransferMoneyApi(object):
    ...
    def transfer_post(self, **kwargs):  # noqa: E501
        """https::devtest.baokim.vn/Sandbox/FirmBanking  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.transfer_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param TransferBody body: Process:
...
2. If the correct information will return successful transfer. 
 ...
 Note(*) : If the transaction is pending, the Partner must wait for the final result from Baokim by calling the <a href='/baokim-firm-open-api-9003'> Function look up for transfer info </a>.
        ...
        if kwargs.get('async_req'):
            return self.transfer_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.transfer_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def transfer_post_with_http_info(self, **kwargs):  # noqa: E501
        """https::devtest.baokim.vn/Sandbox/FirmBanking  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.transfer_post_with_http_info(async_req=True)
        >>> result = thread.get()
