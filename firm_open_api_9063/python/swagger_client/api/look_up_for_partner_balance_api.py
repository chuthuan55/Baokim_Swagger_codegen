...
class LookUpForPartnerBalanceApi(object):
    ...
    def lookup_balance_post(self, **kwargs):  # noqa: E501
        """https::devtest.baokim.vn/Sandbox/FirmBanking  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.lookup_balance_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param LookupBalanceBody body: Process:
...
2. If the information is correct, return the availale balance.
        ...
        if kwargs.get('async_req'):
            return self.lookup_balance_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.lookup_balance_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def lookup_balance_post_with_http_info(self, **kwargs):  # noqa: E501
        """https::devtest.baokim.vn/Sandbox/FirmBanking  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.lookup_balance_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method lookup_balance_post" % key
                )
            params[key] = val
        del params['kwargs']
