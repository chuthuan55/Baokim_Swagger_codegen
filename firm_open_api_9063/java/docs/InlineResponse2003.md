...
**requestId** | **String** | Request id that partner sent |  [optional]
**partnerCode** | **String** | The code of partner |  [optional]
**available** | **Integer** | Total partner’s available balance |  [optional]
**holding** | **Integer** | Total money is pending |  [optional]
