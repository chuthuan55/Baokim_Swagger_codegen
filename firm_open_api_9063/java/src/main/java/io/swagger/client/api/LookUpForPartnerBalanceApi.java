...
import io.swagger.client.model.LookupBalanceBody;
...
public class LookUpForPartnerBalanceApi {
    private ApiClient apiClient;

    public LookUpForPartnerBalanceApi() {
        this(Configuration.getDefaultApiClient());
    }

    public LookUpForPartnerBalanceApi(ApiClient apiClient) {
    ...
    /**
     * Build call for lookupBalancePost
     * @param body Process:
...
2. If the information is correct, return the availale balance. (optional)
     ...
     */
    public com.squareup.okhttp.Call lookupBalancePostCall(LookupBalanceBody body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/LookupBalance";
    ...
    private com.squareup.okhttp.Call lookupBalancePostValidateBeforeCall(LookupBalanceBody body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = lookupBalancePostCall(body, progressListener, progressRequestListener);
        return call;
...
2. If the information is correct, return the availale balance. (optional)
     ...
     */
    public InlineResponse2003 lookupBalancePost(LookupBalanceBody body) throws ApiException {
        ApiResponse<InlineResponse2003> resp = lookupBalancePostWithHttpInfo(body);
        return resp.getData();
    }
...
2. If the information is correct, return the availale balance. (optional)
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2003> lookupBalancePostWithHttpInfo(LookupBalanceBody body) throws ApiException {
        com.squareup.okhttp.Call call = lookupBalancePostValidateBeforeCall(body, null, null);
...
2. If the information is correct, return the availale balance. (optional)
     ...
     */
    public com.squareup.okhttp.Call lookupBalancePostAsync(LookupBalanceBody body, final ApiCallback<InlineResponse2003> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = lookupBalancePostValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse2003>(){}.getType();
