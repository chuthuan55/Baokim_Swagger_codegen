...
public class LookupBalanceBody {
  ...
  public LookupBalanceBody requestId(String requestId) {
  ...
  **/
  ...
  public LookupBalanceBody requestTime(String requestTime) {
  ...
  **/
  ...
  public LookupBalanceBody partnerCode(String partnerCode) {
  ...
  **/
  ...
  public LookupBalanceBody operation(String operation) {
   ...
   * @return operation
  **/
  @Schema(example = "9004", description = "This parameter will determine which function partner is calling. For lookup balance information, the fix is (9004)")
  ...
  public LookupBalanceBody signature(String signature) {
    this.signature = signature;
    return this;
  }

   /**
   * The partner will digitally sign up data using the RSACryptoServiceProvider algorithm. Before sending to will base64 encoding. Data is structured: RequestId|RequestTime| PartnerCode|Operation
   * @return signature
  **/
  @Schema(example = "xzzhBMeZuDNPDD1TE9q3ojo+SSwA/FehW3H77y+3JkNHrdpRentPD 1TE9q3ojo FehW3H77y+3JkNHrdpRentPDbbqw =", description = "The partner will digitally sign up data using the RSACryptoServiceProvider algorithm. Before sending to will base64 encoding. Data is structured: RequestId|RequestTime| PartnerCode|Operation")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    LookupBalanceBody lookupBalanceBody = (LookupBalanceBody) o;
    return Objects.equals(this.requestId, lookupBalanceBody.requestId) &&
        Objects.equals(this.requestTime, lookupBalanceBody.requestTime) &&
        Objects.equals(this.partnerCode, lookupBalanceBody.partnerCode) &&
        Objects.equals(this.operation, lookupBalanceBody.operation) &&
        Objects.equals(this.signature, lookupBalanceBody.signature);
  }

  @Override
  public int hashCode() {
    return Objects.hash(requestId, requestTime, partnerCode, operation, signature);
  }
  ...
  public String toString() {
    ...
    sb.append("class LookupBalanceBody {\n");
