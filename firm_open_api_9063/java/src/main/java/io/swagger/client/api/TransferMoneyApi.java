...
import io.swagger.client.model.TransferBody;
...
public class TransferMoneyApi {
    ...
    public TransferMoneyApi(ApiClient apiClient) {
...
2. If the correct information will return successful transfer. 
 ...
 Note(*) : If the transaction is pending, the Partner must wait for the final result from Baokim by calling the &lt;a href&#x3D;&#x27;/baokim-firm-open-api-9003&#x27;&gt; Function look up for transfer info &lt;/a&gt;. (optional)
     ...
     */
    public com.squareup.okhttp.Call transferPostCall(TransferBody body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call transferPostValidateBeforeCall(TransferBody body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = transferPostCall(body, progressListener, progressRequestListener);
        return call;
...
2. If the correct information will return successful transfer. 
 ...
 Note(*) : If the transaction is pending, the Partner must wait for the final result from Baokim by calling the &lt;a href&#x3D;&#x27;/baokim-firm-open-api-9003&#x27;&gt; Function look up for transfer info &lt;/a&gt;. (optional)
     ...
     */
    public InlineResponse2001 transferPost(TransferBody body) throws ApiException {
        ApiResponse<InlineResponse2001> resp = transferPostWithHttpInfo(body);
        return resp.getData();
    }
...
2. If the correct information will return successful transfer. 
 ...
 Note(*) : If the transaction is pending, the Partner must wait for the final result from Baokim by calling the &lt;a href&#x3D;&#x27;/baokim-firm-open-api-9003&#x27;&gt; Function look up for transfer info &lt;/a&gt;. (optional)
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2001> transferPostWithHttpInfo(TransferBody body) throws ApiException {
        com.squareup.okhttp.Call call = transferPostValidateBeforeCall(body, null, null);
...
2. If the correct information will return successful transfer. 
 ...
 Note(*) : If the transaction is pending, the Partner must wait for the final result from Baokim by calling the &lt;a href&#x3D;&#x27;/baokim-firm-open-api-9003&#x27;&gt; Function look up for transfer info &lt;/a&gt;. (optional)
     ...
     */
    public com.squareup.okhttp.Call transferPostAsync(TransferBody body, final ApiCallback<InlineResponse2001> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = transferPostValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse2001>(){}.getType();
