...
import io.swagger.client.model.LookupTransferBody;
...
public class LookUpForTransferInfoApi {
    private ApiClient apiClient;

    public LookUpForTransferInfoApi() {
        this(Configuration.getDefaultApiClient());
    }

    public LookUpForTransferInfoApi(ApiClient apiClient) {
    ...
    /**
     * Build call for lookupTransferPost
     * @param body Process:
...
2. If the information is correct, return the transaction information.. (optional)
     ...
     */
    public com.squareup.okhttp.Call lookupTransferPostCall(LookupTransferBody body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/LookupTransfer";
    ...
    private com.squareup.okhttp.Call lookupTransferPostValidateBeforeCall(LookupTransferBody body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = lookupTransferPostCall(body, progressListener, progressRequestListener);
        return call;
...
2. If the information is correct, return the transaction information.. (optional)
     ...
     */
    public InlineResponse2002 lookupTransferPost(LookupTransferBody body) throws ApiException {
        ApiResponse<InlineResponse2002> resp = lookupTransferPostWithHttpInfo(body);
        return resp.getData();
    }
...
2. If the information is correct, return the transaction information.. (optional)
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2002> lookupTransferPostWithHttpInfo(LookupTransferBody body) throws ApiException {
        com.squareup.okhttp.Call call = lookupTransferPostValidateBeforeCall(body, null, null);
        Type localVarReturnType = new TypeToken<InlineResponse2002>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * https::devtest.baokim.vn/Sandbox/FirmBanking (asynchronously)
     * 
     * @param body Process:
...
2. If the information is correct, return the transaction information.. (optional)
     ...
     */
    public com.squareup.okhttp.Call lookupTransferPostAsync(LookupTransferBody body, final ApiCallback<InlineResponse2002> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = lookupTransferPostValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse2002>(){}.getType();
