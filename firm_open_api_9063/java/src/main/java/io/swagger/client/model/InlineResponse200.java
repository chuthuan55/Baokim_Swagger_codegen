...
public class InlineResponse200 {
  ...
  public InlineResponse200 responseCode(Integer responseCode) {
  ...
  **/
   ...
   * @return requestId
  **/
  @Schema(example = "PARTNERBK2018033000001", description = "Partner information posted")
  ...
  public InlineResponse200 bankNo(String bankNo) {
    this.bankNo = bankNo;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse200 accNo(String accNo) {
    this.accNo = accNo;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse200 accType(String accType) {
  ...
  **/
  ...
  public InlineResponse200 accName(String accName) {
   ...
   * @return accName
  **/
  @Schema(example = "TRUONG DUC THUAN", description = "Baokim Customer's name response if customer information is submitted correctly")
  ...
  public InlineResponse200 signature(String signature) {
    this.signature = signature;
    return this;
  }

   /**
   * Baokim will sign with digital signature of data returned using RSACryptoServiceProvider. Returns the base64 encoding. Data is structured: ResponseCode|ResponseMessage|RequestId| BankNo|AccNo|AccType|AccName
   * @return signature
  **/
  @Schema(example = "zoUhBMeZuDNPDD1TE9q3ojo+SSwA/FehW3H77y+3JkNHrdpRentPD 1TE9q3ojo FehW3H77y+3JkNHrdpRentPDmwk =", description = "Baokim will sign with digital signature of data returned using RSACryptoServiceProvider. Returns the base64 encoding. Data is structured: ResponseCode|ResponseMessage|RequestId| BankNo|AccNo|AccType|AccName")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.responseCode, inlineResponse200.responseCode) &&
        ...
        Objects.equals(this.bankNo, inlineResponse200.bankNo) &&
        Objects.equals(this.accNo, inlineResponse200.accNo) &&
        Objects.equals(this.accType, inlineResponse200.accType) &&
        Objects.equals(this.accName, inlineResponse200.accName) &&
        Objects.equals(this.signature, inlineResponse200.signature);
  }

  @Override
  public int hashCode() {
    return Objects.hash(responseCode, responseMessage, requestId, bankNo, accNo, accType, accName, signature);
  }
