...
import io.swagger.client.model.VerifyBody;
...
public class VerifyCustomerInformationApi {
    ...
    public VerifyCustomerInformationApi(ApiClient apiClient) {
     ...
     * @param body 1. Partner will call the customer authentication function, Baokim will check the data format and signature authentication..
...
3. If the information is correct, Baokim will return successful information and corresponding customer name. (optional)
     ...
     */
    public com.squareup.okhttp.Call verifyPostCall(VerifyBody body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call verifyPostValidateBeforeCall(VerifyBody body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = verifyPostCall(body, progressListener, progressRequestListener);
        return call;
...
3. If the information is correct, Baokim will return successful information and corresponding customer name. (optional)
     ...
     */
    public InlineResponse200 verifyPost(VerifyBody body) throws ApiException {
        ApiResponse<InlineResponse200> resp = verifyPostWithHttpInfo(body);
        return resp.getData();
    }
...
3. If the information is correct, Baokim will return successful information and corresponding customer name. (optional)
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse200> verifyPostWithHttpInfo(VerifyBody body) throws ApiException {
        com.squareup.okhttp.Call call = verifyPostValidateBeforeCall(body, null, null);
...
3. If the information is correct, Baokim will return successful information and corresponding customer name. (optional)
     ...
     */
    public com.squareup.okhttp.Call verifyPostAsync(VerifyBody body, final ApiCallback<InlineResponse200> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = verifyPostValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse200>(){}.getType();
