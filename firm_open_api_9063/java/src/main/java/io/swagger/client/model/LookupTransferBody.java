...
public class LookupTransferBody {
  ...
  public LookupTransferBody requestId(String requestId) {
  ...
  **/
  ...
  public LookupTransferBody requestTime(String requestTime) {
  ...
  **/
  ...
  public LookupTransferBody partnerCode(String partnerCode) {
  ...
  **/
  ...
  public LookupTransferBody operation(String operation) {
   ...
   * @return operation
  **/
  @Schema(example = "9003", description = "This parameter will determine which function partner is calling. For transactional lookup information, the fix is \"9003")
  ...
  public LookupTransferBody referenceId(String referenceId) {
   ...
   * @return referenceId
  **/
  @Schema(example = "5CBCAB920C63CED5E0540010E099E090", description = "Transaction code from PARTNER submitted")
  ...
  public LookupTransferBody signature(String signature) {
   ...
   * @return signature
  **/
  @Schema(example = "zzhBMeZuDNPDD1TE9q3ojo+SSwA/FehW3H77y+3JkNHrdpRentPD 1TE9q3ojo FehW3H77y+3JkNHrdpRentPDbb =", description = "The partner will digitally sign up data using the RSACryptoServiceProvider algorithm. Before sending to will base64 encoding. Data is structured: RequestId|RequestTime|PartnerCode| Operation|ReferenceId")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    LookupTransferBody lookupTransferBody = (LookupTransferBody) o;
    return Objects.equals(this.requestId, lookupTransferBody.requestId) &&
        Objects.equals(this.requestTime, lookupTransferBody.requestTime) &&
        Objects.equals(this.partnerCode, lookupTransferBody.partnerCode) &&
        Objects.equals(this.operation, lookupTransferBody.operation) &&
        Objects.equals(this.referenceId, lookupTransferBody.referenceId) &&
        Objects.equals(this.signature, lookupTransferBody.signature);
  }

  @Override
  public int hashCode() {
    return Objects.hash(requestId, requestTime, partnerCode, operation, referenceId, signature);
  }
