...
public class TransferBody {
  ...
  public TransferBody requestId(String requestId) {
   ...
   * @return requestId
  **/
  @Schema(example = "PARTNERBK2018033000002", description = "The only code that corresponds to an upload request. Proposed format is as follows: PartnerCode + BK + YYYYMMDD + UniqueId")
  ...
  public TransferBody requestTime(String requestTime) {
   ...
   * @return requestTime
  **/
  @Schema(example = "2018-03-30 11:20:32", description = "It is time to send request from Partner, format: YYYY-MM-DD HH:MM:SS")
  ...
  public TransferBody partnerCode(String partnerCode) {
   ...
   * @return partnerCode
  **/
  @Schema(example = "PARTNER", description = "The partner code is defined in the Baokim system. This code will send to the partner when the integration begins.")
  ...
  public TransferBody operation(String operation) {
   ...
   * @return operation
  **/
  @Schema(example = "9002", description = "This parameter will determine which function partner is calling. For the transfer function, the fix is “9002”")
  ...
  public TransferBody referenceId(String referenceId) {
   ...
   * @return referenceId
  **/
  @Schema(example = "5CBCAB920C63CED5E0540010E099E090", description = "Transaction code sent by the partner")
  ...
  public TransferBody bankNo(String bankNo) {
    this.bankNo = bankNo;
    return this;
  }
   ...
   * @return bankNo
  **/
  @Schema(example = "970436", description = "Bank code in accordance with Baokim is defined in the section 8. List of remittance banks")
  ...
  public TransferBody accNo(String accNo) {
    this.accNo = accNo;
    return this;
  }
   ...
   * @return accNo
  **/
  @Schema(example = "0021000382448", description = "Account number or bank card number of the customer.")
  ...
  public TransferBody accType(String accType) {
   ...
   * @return accType
  **/
  @Schema(example = "0", description = "AccNo classification 0: Bank account number 1: Bank card number")
  ...
  public TransferBody requestAmount(String requestAmount) {
  ...
  **/
  @Schema(example = "1000000", description = "The amount requested by the partner to transfer to the recipient.")
  ...
  public TransferBody memo(String memo) {
    this.memo = memo;
    return this;
  }
   ...
   * @return memo
  **/
  @Schema(example = "transfer money to customers", description = "Money transfer contents")
  ...
  public TransferBody signature(String signature) {
   ...
   * @return signature
  **/
  @Schema(example = "zzhBMeZuDNPDD1TE9q3ojo+SSwA/FehW3H77y+3JkNHrdpRentPD 1TE9q3ojo FehW3H77y+3JkNHrdpRentPDbb =", description = "The partner will sign with digital signature of data transmitted using the algorithm RSACryptoServiceProvider. Before sending ,data will be base64 encoding. Data follow this structure: RequestId|RequestTime|PartnerCode| Operation|ReferenceId|BankNo|AccNo| AccType|RequestAmount|Memo")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.requestId, transferBody.requestId) &&
        Objects.equals(this.requestTime, transferBody.requestTime) &&
        Objects.equals(this.partnerCode, transferBody.partnerCode) &&
        Objects.equals(this.operation, transferBody.operation) &&
        Objects.equals(this.referenceId, transferBody.referenceId) &&
        Objects.equals(this.bankNo, transferBody.bankNo) &&
        Objects.equals(this.accNo, transferBody.accNo) &&
        Objects.equals(this.accType, transferBody.accType) &&
        Objects.equals(this.requestAmount, transferBody.requestAmount) &&
        Objects.equals(this.memo, transferBody.memo) &&
        Objects.equals(this.signature, transferBody.signature);
  }

  @Override
  public int hashCode() {
    return Objects.hash(requestId, requestTime, partnerCode, operation, referenceId, bankNo, accNo, accType, requestAmount, memo, signature);
  }
