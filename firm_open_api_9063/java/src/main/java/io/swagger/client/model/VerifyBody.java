...
public class VerifyBody {
  ...
  public VerifyBody requestId(String requestId) {
   ...
   * @return requestId
  **/
  @Schema(example = "PARTNERBK2018033000001", description = "The only code that corresponds to an upload request. Proposed format is as follows: PartnerCode + BK + YYYYMMDD + UniqueId")
  ...
  public VerifyBody requestTime(String requestTime) {
  ...
  **/
  ...
  public VerifyBody partnerCode(String partnerCode) {
   ...
   * @return partnerCode
  **/
  @Schema(example = "DEMOCHIHO", description = "The partner code is defined in the Baokim system. This code will send to the partner when the integration begins.")
  ...
  public VerifyBody operation(String operation) {
   ...
   * @return operation
  **/
  @Schema(example = "9001", description = "This parameter will determine which function that partner is calling. For customer authentication functions, the fix is “9001”")
  ...
  public VerifyBody bankNo(String bankNo) {
    this.bankNo = bankNo;
    return this;
  }
  ...
  **/
  ...
  public VerifyBody accNo(String accNo) {
    this.accNo = accNo;
    return this;
  }
  ...
  **/
  ...
  public VerifyBody accType(String accType) {
  ...
  **/
  ...
  public VerifyBody signature(String signature) {
   ...
   * @return signature
  **/
  @Schema(example = "hBMeZuDNPDD1TE9q3ojo+SSwA/FehW3H77y+3JkNHrdpRentPD 1TE9q3ojo FehW3H77y+3JkNHrdpRentPD =", description = "The partner will sign with digital signature of data transmitted using the algorithm RSACryptoServiceProvider. Before sending ,data will be base64 encoding. Data follow this structure: RequestId|RequestTime| PartnerCode|Operation|BankNo| AccNo|AccType")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    VerifyBody verifyBody = (VerifyBody) o;
    return Objects.equals(this.requestId, verifyBody.requestId) &&
        Objects.equals(this.requestTime, verifyBody.requestTime) &&
        Objects.equals(this.partnerCode, verifyBody.partnerCode) &&
        Objects.equals(this.operation, verifyBody.operation) &&
        Objects.equals(this.bankNo, verifyBody.bankNo) &&
        Objects.equals(this.accNo, verifyBody.accNo) &&
        Objects.equals(this.accType, verifyBody.accType) &&
        Objects.equals(this.signature, verifyBody.signature);
  }

  @Override
  public int hashCode() {
    return Objects.hash(requestId, requestTime, partnerCode, operation, bankNo, accNo, accType, signature);
  }
