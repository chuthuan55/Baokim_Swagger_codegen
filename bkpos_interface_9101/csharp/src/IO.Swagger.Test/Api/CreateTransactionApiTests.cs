...
namespace IO.Swagger.Test
{
    ...
    public class CreateTransactionApiTests
    {
        ...
        {
            // TODO uncomment below to test 'IsInstanceOfType' CreateTransactionApi
            //Assert.IsInstanceOfType(typeof(CreateTransactionApi), instance, "instance is a CreateTransactionApi");
        }

        /// <summary>
        /// Test ApiV1PartnerCreateOrderPost
        /// </summary>
        [Test]
        public void ApiV1PartnerCreateOrderPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //PartnerCreateorderBody body = null;
            //var response = instance.ApiV1PartnerCreateOrderPost(body);
