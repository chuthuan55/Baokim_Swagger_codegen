...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
        public interface ICancelOrderApi : IApiAccessor
    {
...
2. If the correct information will return successful. (optional)</param>
...
2. If the correct information will return successful. (optional)</param>
        ...
        ApiResponse<InlineResponse2003> ApiV1PartnerCancelOrderPostWithHttpInfo (PartnerCancelorderBody body = null);
...
2. If the correct information will return successful. (optional)</param>
        ...
        System.Threading.Tasks.Task<InlineResponse2003> ApiV1PartnerCancelOrderPostAsync (PartnerCancelorderBody body = null);
...
2. If the correct information will return successful. (optional)</param>
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2003>> ApiV1PartnerCancelOrderPostAsyncWithHttpInfo (PartnerCancelorderBody body = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class CancelOrderApi : ICancelOrderApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="CancelOrderApi"/> class.
        /// </summary>
        /// <returns></returns>
        public CancelOrderApi(String basePath)
        {
        ...
        /// <returns></returns>
        public CancelOrderApi(IO.Swagger.Client.Configuration configuration = null)
        {
...
2. If the correct information will return successful. (optional)</param>
        /// <returns>InlineResponse2003</returns>
        public InlineResponse2003 ApiV1PartnerCancelOrderPost (PartnerCancelorderBody body = null)
        {
             ApiResponse<InlineResponse2003> localVarResponse = ApiV1PartnerCancelOrderPostWithHttpInfo(body);
...
2. If the correct information will return successful. (optional)</param>
        /// <returns>ApiResponse of InlineResponse2003</returns>
        public ApiResponse< InlineResponse2003 > ApiV1PartnerCancelOrderPostWithHttpInfo (PartnerCancelorderBody body = null)
        {

            var localVarPath = "/api/v1/partner/cancel-order";
            ...
            {
                Exception exception = ExceptionFactory("ApiV1PartnerCancelOrderPost", localVarResponse);
...
2. If the correct information will return successful. (optional)</param>
        /// <returns>Task of InlineResponse2003</returns>
        public async System.Threading.Tasks.Task<InlineResponse2003> ApiV1PartnerCancelOrderPostAsync (PartnerCancelorderBody body = null)
        {
             ApiResponse<InlineResponse2003> localVarResponse = await ApiV1PartnerCancelOrderPostAsyncWithHttpInfo(body);
             return localVarResponse.Data;
...
2. If the correct information will return successful. (optional)</param>
        /// <returns>Task of ApiResponse (InlineResponse2003)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse2003>> ApiV1PartnerCancelOrderPostAsyncWithHttpInfo (PartnerCancelorderBody body = null)
        {
