...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class InlineResponse106 :  IEquatable<InlineResponse106>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse106" /> class.
        /// </summary>
        /// <param name="responseCode">responseCode.</param>
        /// <param name="responseMessage">responseMessage.</param>
        /// <param name="data">data.</param>
        /// <param name="signature">signature.</param>
        public InlineResponse106(int? responseCode = default(int?), string responseMessage = default(string), InlineResponse106Data data = default(InlineResponse106Data), string signature = default(string))
        {
        ...
        public InlineResponse106Data Data { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse106);
        }

        /// <summary>
        /// Returns true if InlineResponse106 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse106 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse106 input)
        {
            if (input == null)
                return false;
