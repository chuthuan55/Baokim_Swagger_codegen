...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2003 :  IEquatable<InlineResponse2003>, IValidatableObject
    {
        ...
        public InlineResponse2003(int? responseCode = default(int?), string responseMessage = default(string), InlineResponse2002Data data = default(InlineResponse2002Data), string signature = default(string))
        {
