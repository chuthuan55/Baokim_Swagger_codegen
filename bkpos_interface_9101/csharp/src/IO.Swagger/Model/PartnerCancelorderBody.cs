...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PartnerCancelorderBody :  IEquatable<PartnerCancelorderBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PartnerCancelorderBody" /> class.
        /// </summary>
        ...
        public PartnerCancelorderBody(string requestId = default(string), string requestTime = default(string), string partnerCode = default(string), string operation = default(string), string referenceId = default(string), string reason = default(string))
        {
        ...
        {
            return this.Equals(input as PartnerCancelorderBody);
        }

        /// <summary>
        /// Returns true if PartnerCancelorderBody instances are equal
        /// </summary>
        /// <param name="input">Instance of PartnerCancelorderBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PartnerCancelorderBody input)
        {
            if (input == null)
                return false;
