...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse200 :  IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        public InlineResponse200(int? responseCode = default(int?), string responseMessage = default(string), InlineResponse157Data data = default(InlineResponse157Data), string signature = default(string))
        {
