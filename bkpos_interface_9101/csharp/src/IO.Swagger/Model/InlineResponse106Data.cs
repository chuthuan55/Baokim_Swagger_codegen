...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class InlineResponse106Data :  IEquatable<InlineResponse106Data>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse106Data" /> class.
        /// </summary>
        /// <param name="requestId">requestId.</param>
        /// <param name="requestTime">requestTime.</param>
        /// <param name="operation">operation.</param>
        /// <param name="partnerCode">partnerCode.</param>
        public InlineResponse106Data(string requestId = default(string), string requestTime = default(string), string operation = default(string), string partnerCode = default(string))
        {
        ...
        {
            return this.Equals(input as InlineResponse106Data);
        }

        /// <summary>
        /// Returns true if InlineResponse106Data instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse106Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse106Data input)
        {
            if (input == null)
                return false;
