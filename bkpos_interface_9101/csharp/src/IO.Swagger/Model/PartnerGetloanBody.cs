...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PartnerGetloanBody :  IEquatable<PartnerGetloanBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PartnerGetloanBody" /> class.
        /// </summary>
        /// <param name="requestId">requestId.</param>
        /// <param name="requestTime">requestTime.</param>
        /// <param name="partnerCode">partnerCode.</param>
        /// <param name="operation">operation.</param>
        public PartnerGetloanBody(string requestId = default(string), string requestTime = default(string), string partnerCode = default(string), string operation = default(string))
        {
        ...
        {
            return this.Equals(input as PartnerGetloanBody);
        }

        /// <summary>
        /// Returns true if PartnerGetloanBody instances are equal
        /// </summary>
        /// <param name="input">Instance of PartnerGetloanBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PartnerGetloanBody input)
        {
            if (input == null)
                return false;
