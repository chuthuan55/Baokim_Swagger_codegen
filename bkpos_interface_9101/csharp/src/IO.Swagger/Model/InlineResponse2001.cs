...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2001 :  IEquatable<InlineResponse2001>, IValidatableObject
    {
        ...
        public InlineResponse2001(int? responseCode = default(int?), string responseMessage = default(string), InlineResponse2001Data data = default(InlineResponse2001Data), string signature = default(string))
        {
