...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PartnerCheckinstallmentBody :  IEquatable<PartnerCheckinstallmentBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PartnerCheckinstallmentBody" /> class.
        /// </summary>
        ...
        public PartnerCheckinstallmentBody(string requestId = default(string), string requestTime = default(string), string partnerCode = default(string), string operation = default(string), string cardNo = default(string), string bankCode = default(string))
        {
        ...
        {
            return this.Equals(input as PartnerCheckinstallmentBody);
        }

        /// <summary>
        /// Returns true if PartnerCheckinstallmentBody instances are equal
        /// </summary>
        /// <param name="input">Instance of PartnerCheckinstallmentBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PartnerCheckinstallmentBody input)
        {
            if (input == null)
                return false;
