...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2002Data :  IEquatable<InlineResponse2002Data>, IValidatableObject
    {
        ...
        /// <param name="bkTransId">bkTransId.</param>
        public InlineResponse2002Data(string requestId = default(string), string requestTime = default(string), string cardNo = default(string), string bankCode = default(string), string operation = default(string), string partnerCode = default(string), string customerName = default(string), string customerPhone = default(string), string customerEmail = default(string), string productName = default(string), string clientIdNo = default(string), string authCode = default(string), string downPayment = default(string), string originalPrice = default(string), string conversionMoney = default(string), string payPerMonth = default(string), string installmentAmount = default(string), string totalPaymentAmount = default(string), string referenceId = default(string), string bkTransId = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets BkTransId
        /// </summary>
        [DataMember(Name="BkTransId", EmitDefaultValue=false)]
        public string BkTransId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BkTransId: ").Append(BkTransId).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InlineResponse2002Data input)
        {
            ...
            return 
                ...
                (
                    this.BkTransId == input.BkTransId ||
                    (this.BkTransId != null &&
                    this.BkTransId.Equals(input.BkTransId))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BkTransId != null)
                    hashCode = hashCode * 59 + this.BkTransId.GetHashCode();
                return hashCode;
            }
        }
