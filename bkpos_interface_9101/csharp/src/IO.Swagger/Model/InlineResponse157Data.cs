...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class InlineResponse157Data :  IEquatable<InlineResponse157Data>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse157Data" /> class.
        /// </summary>
        ...
        public InlineResponse157Data(string requestId = default(string), string requestTime = default(string), string cardNo = default(string), string bankCode = default(string), string operation = default(string), string partnerCode = default(string))
        {
        ...
        {
            return this.Equals(input as InlineResponse157Data);
        }

        /// <summary>
        /// Returns true if InlineResponse157Data instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse157Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse157Data input)
        {
            if (input == null)
                return false;
