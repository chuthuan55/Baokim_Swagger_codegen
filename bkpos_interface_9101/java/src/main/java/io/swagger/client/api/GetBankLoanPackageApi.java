...
import io.swagger.client.model.InlineResponse106;
import io.swagger.client.model.InlineResponse2001;
import io.swagger.client.model.PartnerGetloanBody;
...
public class GetBankLoanPackageApi {
    private ApiClient apiClient;

    public GetBankLoanPackageApi() {
        this(Configuration.getDefaultApiClient());
    }

    public GetBankLoanPackageApi(ApiClient apiClient) {
    ...
    /**
     * Build call for apiV1PartnerGetLoanPost
     * @param body Process:
...
2. If the correct information will return the list of banks. (optional)
     ...
     */
    public com.squareup.okhttp.Call apiV1PartnerGetLoanPostCall(PartnerGetloanBody body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/api/v1/partner/get-loan";
    ...
    private com.squareup.okhttp.Call apiV1PartnerGetLoanPostValidateBeforeCall(PartnerGetloanBody body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = apiV1PartnerGetLoanPostCall(body, progressListener, progressRequestListener);
        return call;
...
2. If the correct information will return the list of banks. (optional)
     ...
     */
    public InlineResponse2001 apiV1PartnerGetLoanPost(PartnerGetloanBody body) throws ApiException {
        ApiResponse<InlineResponse2001> resp = apiV1PartnerGetLoanPostWithHttpInfo(body);
        return resp.getData();
    }
...
2. If the correct information will return the list of banks. (optional)
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2001> apiV1PartnerGetLoanPostWithHttpInfo(PartnerGetloanBody body) throws ApiException {
        com.squareup.okhttp.Call call = apiV1PartnerGetLoanPostValidateBeforeCall(body, null, null);
...
2. If the correct information will return the list of banks. (optional)
     ...
     */
    public com.squareup.okhttp.Call apiV1PartnerGetLoanPostAsync(PartnerGetloanBody body, final ApiCallback<InlineResponse2001> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = apiV1PartnerGetLoanPostValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse2001>(){}.getType();
