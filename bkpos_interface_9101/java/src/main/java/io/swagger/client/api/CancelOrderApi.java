...
import io.swagger.client.model.PartnerCancelorderBody;
...
public class CancelOrderApi {
    ...
    /**
     * Build call for apiV1PartnerCancelOrderPost
     * @param body Process:
...
2. If the correct information will return successful. (optional)
     ...
     */
    public com.squareup.okhttp.Call apiV1PartnerCancelOrderPostCall(PartnerCancelorderBody body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/api/v1/partner/cancel-order";
    ...
    private com.squareup.okhttp.Call apiV1PartnerCancelOrderPostValidateBeforeCall(PartnerCancelorderBody body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = apiV1PartnerCancelOrderPostCall(body, progressListener, progressRequestListener);
        return call;
...
2. If the correct information will return successful. (optional)
     ...
     */
    public InlineResponse2003 apiV1PartnerCancelOrderPost(PartnerCancelorderBody body) throws ApiException {
        ApiResponse<InlineResponse2003> resp = apiV1PartnerCancelOrderPostWithHttpInfo(body);
        return resp.getData();
    }
...
2. If the correct information will return successful. (optional)
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2003> apiV1PartnerCancelOrderPostWithHttpInfo(PartnerCancelorderBody body) throws ApiException {
        com.squareup.okhttp.Call call = apiV1PartnerCancelOrderPostValidateBeforeCall(body, null, null);
...
2. If the correct information will return successful. (optional)
     ...
     */
    public com.squareup.okhttp.Call apiV1PartnerCancelOrderPostAsync(PartnerCancelorderBody body, final ApiCallback<InlineResponse2003> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = apiV1PartnerCancelOrderPostValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse2003>(){}.getType();
