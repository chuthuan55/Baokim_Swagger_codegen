...
/**
 * API tests for GetBankLoanPackageApi
 */
@Ignore
public class GetBankLoanPackageApiTest {

    private final GetBankLoanPackageApi api = new GetBankLoanPackageApi();
     ...
     */
    @Test
    public void apiV1PartnerGetLoanPostTest() throws Exception {
        PartnerGetloanBody body = null;
        InlineResponse2001 response = api.apiV1PartnerGetLoanPost(body);
