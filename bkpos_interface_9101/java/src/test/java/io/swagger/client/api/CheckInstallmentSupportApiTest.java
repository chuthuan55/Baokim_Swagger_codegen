...
/**
 * API tests for CheckInstallmentSupportApi
 */
@Ignore
public class CheckInstallmentSupportApiTest {

    private final CheckInstallmentSupportApi api = new CheckInstallmentSupportApi();
     ...
     */
    @Test
    public void apiV1PartnerCheckInstallmentPostTest() throws Exception {
        PartnerCheckinstallmentBody body = null;
        InlineResponse200 response = api.apiV1PartnerCheckInstallmentPost(body);
