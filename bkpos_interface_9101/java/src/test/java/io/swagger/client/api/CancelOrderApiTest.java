...
public class CancelOrderApiTest {
    ...
    private final CancelOrderApi api = new CancelOrderApi();
     ...
     */
    @Test
    public void apiV1PartnerCancelOrderPostTest() throws Exception {
        PartnerCancelorderBody body = null;
        InlineResponse2003 response = api.apiV1PartnerCancelOrderPost(body);
