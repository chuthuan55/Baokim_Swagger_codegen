...
class CancelOrderApi
{
    ...
    /**
     * Operation apiV1PartnerCancelOrderPost
     *
     * https::devtest.baokim.vn/api/v1/partner/installment
     *
     * @param  \Swagger\Client\Model\PartnerCancelorderBody $body Process:
...
2. If the correct information will return successful. (optional)
     ...
     */
    public function apiV1PartnerCancelOrderPost($body = null)
    {
        list($response) = $this->apiV1PartnerCancelOrderPostWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation apiV1PartnerCancelOrderPostWithHttpInfo
     *
     * https::devtest.baokim.vn/api/v1/partner/installment
     *
     * @param  \Swagger\Client\Model\PartnerCancelorderBody $body Process:
...
2. If the correct information will return successful. (optional)
     ...
     */
    public function apiV1PartnerCancelOrderPostWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2003';
        $request = $this->apiV1PartnerCancelOrderPostRequest($body);
    ...
    /**
     * Operation apiV1PartnerCancelOrderPostAsync
     *
     * https::devtest.baokim.vn/api/v1/partner/installment
     *
     * @param  \Swagger\Client\Model\PartnerCancelorderBody $body Process:
...
2. If the correct information will return successful. (optional)
     ...
     */
    public function apiV1PartnerCancelOrderPostAsync($body = null)
    {
        return $this->apiV1PartnerCancelOrderPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiV1PartnerCancelOrderPostAsyncWithHttpInfo
     *
     * https::devtest.baokim.vn/api/v1/partner/installment
     *
     * @param  \Swagger\Client\Model\PartnerCancelorderBody $body Process:
...
2. If the correct information will return successful. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1PartnerCancelOrderPostAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2003';
        $request = $this->apiV1PartnerCancelOrderPostRequest($body);
    ...
    /**
     * Create request for operation 'apiV1PartnerCancelOrderPost'
     *
     * @param  \Swagger\Client\Model\PartnerCancelorderBody $body Process:
...
2. If the correct information will return successful. (optional)
     ...
     */
    protected function apiV1PartnerCancelOrderPostRequest($body = null)
    {

        $resourcePath = '/api/v1/partner/cancel-order';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
