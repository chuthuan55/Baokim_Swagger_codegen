...
/**
 * CreateTransactionApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class CreateTransactionApi
{
    ...
    /**
     * Operation apiV1PartnerCreateOrderPost
     *
     * https::devtest.baokim.vn/api/v1/partner/installment
     *
     * @param  \Swagger\Client\Model\PartnerCreateorderBody $body Process:
...
2. BAOKIM will check this transaction information with the bank, if the transaction has been paid, BAOKIM will initiate the transaction on the system and transfer the information to ISSUING BANK to perform the installment conversion transaction. (optional)
     ...
     */
    public function apiV1PartnerCreateOrderPost($body = null)
    {
        list($response) = $this->apiV1PartnerCreateOrderPostWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation apiV1PartnerCreateOrderPostWithHttpInfo
     *
     * https::devtest.baokim.vn/api/v1/partner/installment
     *
     * @param  \Swagger\Client\Model\PartnerCreateorderBody $body Process:
...
2. BAOKIM will check this transaction information with the bank, if the transaction has been paid, BAOKIM will initiate the transaction on the system and transfer the information to ISSUING BANK to perform the installment conversion transaction. (optional)
     ...
     */
    public function apiV1PartnerCreateOrderPostWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2002';
        $request = $this->apiV1PartnerCreateOrderPostRequest($body);
    ...
    /**
     * Operation apiV1PartnerCreateOrderPostAsync
     *
     * https::devtest.baokim.vn/api/v1/partner/installment
     *
     * @param  \Swagger\Client\Model\PartnerCreateorderBody $body Process:
...
2. BAOKIM will check this transaction information with the bank, if the transaction has been paid, BAOKIM will initiate the transaction on the system and transfer the information to ISSUING BANK to perform the installment conversion transaction. (optional)
     ...
     */
    public function apiV1PartnerCreateOrderPostAsync($body = null)
    {
        return $this->apiV1PartnerCreateOrderPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiV1PartnerCreateOrderPostAsyncWithHttpInfo
     *
     * https::devtest.baokim.vn/api/v1/partner/installment
     *
     * @param  \Swagger\Client\Model\PartnerCreateorderBody $body Process:
...
2. BAOKIM will check this transaction information with the bank, if the transaction has been paid, BAOKIM will initiate the transaction on the system and transfer the information to ISSUING BANK to perform the installment conversion transaction. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1PartnerCreateOrderPostAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2002';
        $request = $this->apiV1PartnerCreateOrderPostRequest($body);
    ...
    /**
     * Create request for operation 'apiV1PartnerCreateOrderPost'
     *
     * @param  \Swagger\Client\Model\PartnerCreateorderBody $body Process:
...
2. BAOKIM will check this transaction information with the bank, if the transaction has been paid, BAOKIM will initiate the transaction on the system and transfer the information to ISSUING BANK to perform the installment conversion transaction. (optional)
     ...
     */
    protected function apiV1PartnerCreateOrderPostRequest($body = null)
    {

        $resourcePath = '/api/v1/partner/create-order';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
