...
class GetBankLoanPackageApi(object):
    ...
    def api_v1_partner_get_loan_post(self, **kwargs):  # noqa: E501
        """https::devtest.baokim.vn/api/v1/partner/installment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v1_partner_get_loan_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PartnerGetloanBody body: Process:
...
2. If the correct information will return the list of banks.
        ...
        if kwargs.get('async_req'):
            return self.api_v1_partner_get_loan_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.api_v1_partner_get_loan_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def api_v1_partner_get_loan_post_with_http_info(self, **kwargs):  # noqa: E501
        """https::devtest.baokim.vn/api/v1/partner/installment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v1_partner_get_loan_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api_v1_partner_get_loan_post" % key
                )
            params[key] = val
        del params['kwargs']
