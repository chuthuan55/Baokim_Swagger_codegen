...
/**
 * PaymenttxnCalculatebankfeeBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PaymenttxnCalculatebankfeeBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'paymenttxn_calculatebankfee_body';
...
'bpm_id' => 'getBpmId'    ];
     ...
     * Sets amount
     *
     * @param int $amount Amount to calculate Bao Kim fee
     *
     * @return $this
     */
