...
/**
 * OrderSendBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrderSendBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'order_send_body';
...
'customer_address' => 'getCustomerAddress'    ];
     ...
     * Sets total_amount
     *
     * @param int $total_amount Order amount
     *
     * @return $this
     */
     ...
     * Sets url_success
     *
     * @param string $url_success URL redirect after payment success
     *
     * @return $this
     */
     ...
     * Sets url_detail
     *
     * @param string $url_detail Order detail url (redirected when customer cancels order)
     *
     * @return $this
     */
     ...
     * Sets bpm_id
     *
     * @param int $bpm_id Bank payment method ID
     *
     * @return $this
     */
