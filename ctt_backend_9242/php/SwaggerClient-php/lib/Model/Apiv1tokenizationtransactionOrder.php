...
/**
 * Apiv1tokenizationtransactionOrder Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Apiv1tokenizationtransactionOrder implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'apiv1tokenizationtransaction_order';
...
'customer_phone' => 'getCustomerPhone'    ];
     ...
     * Sets mrc_order_id
     *
     * @param string $mrc_order_id Merchant Order ID
     *
     * @return $this
     */
     ...
     * Sets total_amount
     *
     * @param int $total_amount Order amount (Not required if api_operation = PAY and init_token = 1)
     *
     * @return $this
     */
     ...
     * Sets url_success
     *
     * @param string $url_success URL redirect when payment success
     *
     * @return $this
     */
     ...
     * Sets url_detail
     *
     * @param string $url_detail URL redirect when payment failed or canceled
     *
     * @return $this
     */
     ...
     * Sets webhooks
     *
     * @param string $webhooks URL is used to send notification to sales website, chat, ... when the payment order is successful, allows notify to multiple urls, separated by commas
     *
     * @return $this
     */
     ...
     * Sets customer_phone
     *
     * @param string $customer_phone Customer's Phone
     *
     * @return $this
     */
