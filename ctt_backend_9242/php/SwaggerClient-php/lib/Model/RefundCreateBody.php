...
/**
 * RefundCreateBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RefundCreateBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'refund_create_body';
...
'description' => 'getDescription'    ];
     ...
     * Sets txn_id
     *
     * @param int $txn_id Payment transaction ID
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description Refund description (max 255 characters)
     *
     * @return $this
     */
