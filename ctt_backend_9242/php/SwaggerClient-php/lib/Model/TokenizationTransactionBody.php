...
/**
 * TokenizationTransactionBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TokenizationTransactionBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tokenization_transaction_body';
...
'merchant_id' => 'int',
'init_token' => 'int',
'order' => '\Swagger\Client\Model\Apiv1tokenizationtransactionOrder',
'card' => '\Swagger\Client\Model\Apiv1tokenizationtransactionCard'    ];
...
'card' => 'card'    ];
    ...
    protected static $setters = [
        'api_operation' => 'setApiOperation',
'merchant_id' => 'setMerchantId',
'init_token' => 'setInitToken',
'order' => 'setOrder',
'card' => 'setCard'    ];
    ...
    protected static $getters = [
        'api_operation' => 'getApiOperation',
'merchant_id' => 'getMerchantId',
'init_token' => 'getInitToken',
'order' => 'getOrder',
'card' => 'getCard'    ];
    ...
    {
        $this->container['api_operation'] = isset($data['api_operation']) ? $data['api_operation'] : null;
        $this->container['merchant_id'] = isset($data['merchant_id']) ? $data['merchant_id'] : null;
        $this->container['init_token'] = isset($data['init_token']) ? $data['init_token'] : null;
    ...
    {
        return $this->container['api_operation'];
    }

    /**
     * Sets api_operation
     *
     * @param string $api_operation Type of token order (PAY: generate token and include payment if needed or PAY_BY_TOKEN: pay by token generated before)
     *
     * @return $this
     */
    public function setApiOperation($api_operation)
    {
        $this->container['api_operation'] = $api_operation;
    ...
    {
        return $this->container['init_token'];
    }

    /**
     * Sets init_token
     *
     * @param int $init_token Required with api_operation = PAY, distinguish orders only generate token or include payment. (1: Only generate token, 0: Include payment)
     *
     * @return $this
     */
    public function setInitToken($init_token)
    {
        $this->container['init_token'] = $init_token;
     ...
     * Gets order
     *
     * @return \Swagger\Client\Model\Apiv1tokenizationtransactionOrder
     */
     ...
     * Sets order
     *
     * @param \Swagger\Client\Model\Apiv1tokenizationtransactionOrder $order order
     *
     * @return $this
     */
     ...
     * Gets card
     *
     * @return \Swagger\Client\Model\Apiv1tokenizationtransactionCard
     */
     ...
     * Sets card
     *
     * @param \Swagger\Client\Model\Apiv1tokenizationtransactionCard $card card
     *
     * @return $this
     */
