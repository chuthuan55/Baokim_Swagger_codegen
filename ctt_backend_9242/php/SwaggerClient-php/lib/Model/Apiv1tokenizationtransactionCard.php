...
/**
 * Apiv1tokenizationtransactionCard Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Apiv1tokenizationtransactionCard implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'apiv1tokenizationtransaction_card';
     ...
     * Sets token
     *
     * @param string $token Token used for payment (Required for api_operation = PAY_BY_TOKEN)
     *
     * @return $this
     */
