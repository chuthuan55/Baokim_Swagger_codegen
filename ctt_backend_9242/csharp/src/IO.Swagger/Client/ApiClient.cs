...
namespace IO.Swagger.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("https://dev-api.baokim.vn/payment/");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://dev-api.baokim.vn/payment/).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://dev-api.baokim.vn/payment/")
        {
