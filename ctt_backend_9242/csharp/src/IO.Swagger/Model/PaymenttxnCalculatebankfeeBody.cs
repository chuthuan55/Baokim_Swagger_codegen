...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PaymenttxnCalculatebankfeeBody :  IEquatable<PaymenttxnCalculatebankfeeBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymenttxnCalculatebankfeeBody" /> class.
        /// </summary>
        /// <param name="merchantId">Merchant ID.</param>
        /// <param name="amount">Amount to calculate Bao Kim fee.</param>
        /// <param name="bpmId">Bank payment method ID.</param>
        public PaymenttxnCalculatebankfeeBody(int? merchantId = default(int?), int? amount = default(int?), int? bpmId = default(int?))
        {
        ...
        /// </summary>
        /// <value>Amount to calculate Bao Kim fee</value>
        ...
        {
            return this.Equals(input as PaymenttxnCalculatebankfeeBody);
        }

        /// <summary>
        /// Returns true if PaymenttxnCalculatebankfeeBody instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymenttxnCalculatebankfeeBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymenttxnCalculatebankfeeBody input)
        {
            if (input == null)
                return false;
