...
{
    /// <summary>
    /// PaymenttxnCalculatebkfeeBody
    /// </summary>
    [DataContract]
        public partial class PaymenttxnCalculatebkfeeBody :  IEquatable<PaymenttxnCalculatebkfeeBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymenttxnCalculatebkfeeBody" /> class.
        /// </summary>
        /// <param name="merchantId">Merchant ID.</param>
        /// <param name="amount">Amount to calculate Bao Kim fee.</param>
        public PaymenttxnCalculatebkfeeBody(int? merchantId = default(int?), int? amount = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymenttxnCalculatebkfeeBody {\n");
        ...
        {
            return this.Equals(input as PaymenttxnCalculatebkfeeBody);
        }

        /// <summary>
        /// Returns true if PaymenttxnCalculatebkfeeBody instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymenttxnCalculatebkfeeBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymenttxnCalculatebkfeeBody input)
        {
            if (input == null)
                return false;
