...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Apiv1tokenizationtransactionCard :  IEquatable<Apiv1tokenizationtransactionCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Apiv1tokenizationtransactionCard" /> class.
        /// </summary>
        /// <param name="token">Token used for payment (Required for api_operation &#x3D; PAY_BY_TOKEN).</param>
        public Apiv1tokenizationtransactionCard(string token = default(string))
        {
            this.Token = token;
        }
        
        /// <summary>
        /// Token used for payment (Required for api_operation &#x3D; PAY_BY_TOKEN)
        /// </summary>
        /// <value>Token used for payment (Required for api_operation &#x3D; PAY_BY_TOKEN)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Apiv1tokenizationtransactionCard {\n");
        ...
        {
            return this.Equals(input as Apiv1tokenizationtransactionCard);
        }

        /// <summary>
        /// Returns true if Apiv1tokenizationtransactionCard instances are equal
        /// </summary>
        /// <param name="input">Instance of Apiv1tokenizationtransactionCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Apiv1tokenizationtransactionCard input)
        {
            if (input == null)
                return false;
