...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2002 :  IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        public InlineResponse2002(int? code = default(int?), List<> message = default(List<>), int? count = default(int?), InlineResponse2002Data data = default(InlineResponse2002Data))
        {
            this.Code = code;
