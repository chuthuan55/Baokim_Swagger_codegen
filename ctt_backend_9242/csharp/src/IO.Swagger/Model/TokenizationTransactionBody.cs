...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TokenizationTransactionBody :  IEquatable<TokenizationTransactionBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenizationTransactionBody" /> class.
        /// </summary>
        /// <param name="apiOperation">Type of token order (PAY: generate token and include payment if needed or PAY_BY_TOKEN: pay by token generated before).</param>
        /// <param name="merchantId">Merchant ID.</param>
        /// <param name="initToken">Required with api_operation &#x3D; PAY, distinguish orders only generate token or include payment. (1: Only generate token, 0: Include payment).</param>
        /// <param name="order">order.</param>
        /// <param name="card">card.</param>
        public TokenizationTransactionBody(string apiOperation = default(string), int? merchantId = default(int?), int? initToken = default(int?), Apiv1tokenizationtransactionOrder order = default(Apiv1tokenizationtransactionOrder), Apiv1tokenizationtransactionCard card = default(Apiv1tokenizationtransactionCard))
        {
        ...
        /// </summary>
        /// <value>Type of token order (PAY: generate token and include payment if needed or PAY_BY_TOKEN: pay by token generated before)</value>
        [DataMember(Name="api_operation", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Required with api_operation &#x3D; PAY, distinguish orders only generate token or include payment. (1: Only generate token, 0: Include payment)</value>
        [DataMember(Name="init_token", EmitDefaultValue=false)]
        public int? InitToken { get; set; }

        /// <summary>
        /// Gets or Sets Order
        /// </summary>
        [DataMember(Name="order", EmitDefaultValue=false)]
        public Apiv1tokenizationtransactionOrder Order { get; set; }

        /// <summary>
        /// Gets or Sets Card
        /// </summary>
        [DataMember(Name="card", EmitDefaultValue=false)]
        public Apiv1tokenizationtransactionCard Card { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ApiOperation: ").Append(ApiOperation).Append("\n");
            sb.Append("  MerchantId: ").Append(MerchantId).Append("\n");
            sb.Append("  InitToken: ").Append(InitToken).Append("\n");
        ...
        {
            return this.Equals(input as TokenizationTransactionBody);
        }

        /// <summary>
        /// Returns true if TokenizationTransactionBody instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenizationTransactionBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenizationTransactionBody input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ApiOperation == input.ApiOperation ||
                    (this.ApiOperation != null &&
                    this.ApiOperation.Equals(input.ApiOperation))
                ) && 
                (
                ...
                (
                    this.InitToken == input.InitToken ||
                    (this.InitToken != null &&
                    this.InitToken.Equals(input.InitToken))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ApiOperation != null)
                    hashCode = hashCode * 59 + this.ApiOperation.GetHashCode();
                if (this.MerchantId != null)
                    hashCode = hashCode * 59 + this.MerchantId.GetHashCode();
                if (this.InitToken != null)
                    hashCode = hashCode * 59 + this.InitToken.GetHashCode();
                if (this.Order != null)
