...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Apiv1tokenizationtransactionOrder :  IEquatable<Apiv1tokenizationtransactionOrder>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Apiv1tokenizationtransactionOrder" /> class.
        /// </summary>
        /// <param name="mrcOrderId">Merchant Order ID.</param>
        /// <param name="totalAmount">Order amount (Not required if api_operation &#x3D; PAY and init_token &#x3D; 1).</param>
        /// <param name="description">Order description.</param>
        /// <param name="urlSuccess">URL redirect when payment success.</param>
        /// <param name="urlDetail">URL redirect when payment failed or canceled.</param>
        ...
        public Apiv1tokenizationtransactionOrder(string mrcOrderId = default(string), int? totalAmount = default(int?), string description = default(string), string urlSuccess = default(string), string urlDetail = default(string), string webhooks = default(string), string customerEmail = default(string), string customerPhone = default(string))
        {
        ...
        /// </summary>
        /// <value>Order amount (Not required if api_operation &#x3D; PAY and init_token &#x3D; 1)</value>
        ...
        /// </summary>
        /// <value>URL redirect when payment success</value>
        ...
        /// </summary>
        /// <value>URL redirect when payment failed or canceled</value>
        ...
        {
            return this.Equals(input as Apiv1tokenizationtransactionOrder);
        }

        /// <summary>
        /// Returns true if Apiv1tokenizationtransactionOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of Apiv1tokenizationtransactionOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Apiv1tokenizationtransactionOrder input)
        {
            if (input == null)
                return false;
