...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RefundCreateBody :  IEquatable<RefundCreateBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RefundCreateBody" /> class.
        /// </summary>
        /// <param name="txnId">Payment transaction ID.</param>
        /// <param name="description">Refund description (max 255 characters).</param>
        public RefundCreateBody(int? txnId = default(int?), string description = default(string))
        {
            this.TxnId = txnId;
        ...
        /// <summary>
        /// Refund description (max 255 characters)
        /// </summary>
        /// <value>Refund description (max 255 characters)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RefundCreateBody {\n");
        ...
        {
            return this.Equals(input as RefundCreateBody);
        }

        /// <summary>
        /// Returns true if RefundCreateBody instances are equal
        /// </summary>
        /// <param name="input">Instance of RefundCreateBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefundCreateBody input)
        {
            if (input == null)
                return false;
