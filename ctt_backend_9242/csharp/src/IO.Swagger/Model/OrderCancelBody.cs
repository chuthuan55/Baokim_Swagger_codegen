...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OrderCancelBody :  IEquatable<OrderCancelBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderCancelBody" /> class.
        /// </summary>
        /// <param name="id">Order id.</param>
        public OrderCancelBody(int? id = default(int?))
        {
            this.Id = id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrderCancelBody {\n");
        ...
        {
            return this.Equals(input as OrderCancelBody);
        }

        /// <summary>
        /// Returns true if OrderCancelBody instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderCancelBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderCancelBody input)
        {
            if (input == null)
                return false;
