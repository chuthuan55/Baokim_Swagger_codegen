...
class TestDefaultApi(unittest.TestCase):
    ...
    def test_bpm_list(self):
        """Test case for bpm_list
    ...
    def test_orders_send(self):
        """Test case for orders_send

        Send Order  # noqa: E501
        """
        pass

    def test_payment_calculate_bank_fee(self):
        """Test case for payment_calculate_bank_fee

        Calculate bank payment transaction fee  # noqa: E501
        """
        pass

    def test_payment_calculate_fee(self):
        """Test case for payment_calculate_fee
    ...
    def test_tokenization_send_order(self):
        """Test case for tokenization_send_order
