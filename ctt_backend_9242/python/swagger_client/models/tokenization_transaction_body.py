...
class TokenizationTransactionBody(object):
    ...
    swagger_types = {
        ...
        'merchant_id': 'int',
        'init_token': 'int',
        'order': 'Apiv1tokenizationtransactionOrder',
        'card': 'Apiv1tokenizationtransactionCard'
    }
    ...
    def __init__(self, api_operation=None, merchant_id=None, init_token=None, order=None, card=None):  # noqa: E501
        """TokenizationTransactionBody - a model defined in Swagger"""  # noqa: E501
        self._api_operation = None
    ...
    def api_operation(self):
        """Gets the api_operation of this TokenizationTransactionBody.  # noqa: E501

        Type of token order (PAY: generate token and include payment if needed or PAY_BY_TOKEN: pay by token generated before)  # noqa: E501

        :return: The api_operation of this TokenizationTransactionBody.  # noqa: E501
        :rtype: str
        """
        return self._api_operation

    @api_operation.setter
    def api_operation(self, api_operation):
        """Sets the api_operation of this TokenizationTransactionBody.

        Type of token order (PAY: generate token and include payment if needed or PAY_BY_TOKEN: pay by token generated before)  # noqa: E501

        :param api_operation: The api_operation of this TokenizationTransactionBody.  # noqa: E501
        :type: str
        """
    ...
    def merchant_id(self):
        """Gets the merchant_id of this TokenizationTransactionBody.  # noqa: E501

        Merchant ID  # noqa: E501

        :return: The merchant_id of this TokenizationTransactionBody.  # noqa: E501
        :rtype: int
        """
    ...
    def merchant_id(self, merchant_id):
        """Sets the merchant_id of this TokenizationTransactionBody.

        Merchant ID  # noqa: E501

        :param merchant_id: The merchant_id of this TokenizationTransactionBody.  # noqa: E501
        :type: int
        """
    ...
    @property
    def init_token(self):
        """Gets the init_token of this TokenizationTransactionBody.  # noqa: E501

        Required with api_operation = PAY, distinguish orders only generate token or include payment. (1: Only generate token, 0: Include payment)  # noqa: E501

        :return: The init_token of this TokenizationTransactionBody.  # noqa: E501
        :rtype: int
        """
    ...
    def init_token(self, init_token):
        """Sets the init_token of this TokenizationTransactionBody.

        Required with api_operation = PAY, distinguish orders only generate token or include payment. (1: Only generate token, 0: Include payment)  # noqa: E501

        :param init_token: The init_token of this TokenizationTransactionBody.  # noqa: E501
        :type: int
        """
    ...
    @property
    def order(self):
        """Gets the order of this TokenizationTransactionBody.  # noqa: E501


        :return: The order of this TokenizationTransactionBody.  # noqa: E501
        :rtype: Apiv1tokenizationtransactionOrder
        """
        return self._order

    @order.setter
    def order(self, order):
        """Sets the order of this TokenizationTransactionBody.


        :param order: The order of this TokenizationTransactionBody.  # noqa: E501
        :type: Apiv1tokenizationtransactionOrder
        """
    ...
    @property
    def card(self):
        """Gets the card of this TokenizationTransactionBody.  # noqa: E501


        :return: The card of this TokenizationTransactionBody.  # noqa: E501
        :rtype: Apiv1tokenizationtransactionCard
        """
        return self._card

    @card.setter
    def card(self, card):
        """Sets the card of this TokenizationTransactionBody.


        :param card: The card of this TokenizationTransactionBody.  # noqa: E501
        :type: Apiv1tokenizationtransactionCard
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TokenizationTransactionBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TokenizationTransactionBody):
            return False
