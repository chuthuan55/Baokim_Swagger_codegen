...
class Apiv1tokenizationtransactionCard(object):
    ...
    def __init__(self, token=None):  # noqa: E501
        """Apiv1tokenizationtransactionCard - a model defined in Swagger"""  # noqa: E501
        self._token = None
    ...
    @property
    def token(self):
        """Gets the token of this Apiv1tokenizationtransactionCard.  # noqa: E501

        Token used for payment (Required for api_operation = PAY_BY_TOKEN)  # noqa: E501

        :return: The token of this Apiv1tokenizationtransactionCard.  # noqa: E501
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """Sets the token of this Apiv1tokenizationtransactionCard.

        Token used for payment (Required for api_operation = PAY_BY_TOKEN)  # noqa: E501

        :param token: The token of this Apiv1tokenizationtransactionCard.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Apiv1tokenizationtransactionCard, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Apiv1tokenizationtransactionCard):
            return False
