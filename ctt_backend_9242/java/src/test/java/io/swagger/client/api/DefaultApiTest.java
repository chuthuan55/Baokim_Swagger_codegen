...
public class DefaultApiTest {
     ...
     */
    @Test
    public void bpmListTest() throws Exception {
        InlineResponse2003 response = api.bpmList();
     ...
     */
    @Test
    public void ordersCancelTest() throws Exception {
        OrderCancelBody body = null;
        InlineResponse2002 response = api.ordersCancel(body);
     ...
     */
    @Test
    public void ordersDetailTest() throws Exception {
        Integer id = null;
        String mrcOrderId = null;
        InlineResponse2001 response = api.ordersDetail(id, mrcOrderId);
     ...
     */
    @Test
    public void ordersSendTest() throws Exception {
        OrderSendBody body = null;
        InlineResponse200 response = api.ordersSend(body);
     ...
     */
    @Test
    public void paymentCalculateBankFeeTest() throws Exception {
        PaymenttxnCalculatebankfeeBody body = null;
        InlineResponse2005 response = api.paymentCalculateBankFee(body);
     ...
     */
    @Test
    public void paymentCalculateFeeTest() throws Exception {
        PaymenttxnCalculatebkfeeBody body = null;
        InlineResponse2004 response = api.paymentCalculateFee(body);
     ...
     */
    @Test
    public void refundCreateTest() throws Exception {
        RefundCreateBody body = null;
        InlineResponse2006 response = api.refundCreate(body);
     ...
     */
    @Test
    public void tokenizationSendOrderTest() throws Exception {
        TokenizationTransactionBody body = null;
        InlineResponse200 response = api.tokenizationSendOrder(body);
