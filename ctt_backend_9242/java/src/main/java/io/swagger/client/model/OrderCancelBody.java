...
public class OrderCancelBody {
  ...
  public OrderCancelBody id(Integer id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "78438", description = "Order id")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OrderCancelBody orderCancelBody = (OrderCancelBody) o;
    return Objects.equals(this.id, orderCancelBody.id);
  }
