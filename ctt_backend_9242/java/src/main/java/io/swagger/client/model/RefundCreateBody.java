...
public class RefundCreateBody {
  ...
  public RefundCreateBody txnId(Integer txnId) {
    this.txnId = txnId;
    return this;
  }
   ...
   * @return txnId
  **/
  @Schema(example = "78438", description = "Payment transaction ID")
  ...
  public RefundCreateBody description(String description) {
   ...
   * @return description
  **/
  @Schema(example = "Test Refund", description = "Refund description (max 255 characters)")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RefundCreateBody refundCreateBody = (RefundCreateBody) o;
    return Objects.equals(this.txnId, refundCreateBody.txnId) &&
        Objects.equals(this.description, refundCreateBody.description);
  }

  @Override
  public int hashCode() {
    return Objects.hash(txnId, description);
  }
