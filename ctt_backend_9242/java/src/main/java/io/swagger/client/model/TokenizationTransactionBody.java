...
import io.swagger.client.model.Apiv1tokenizationtransactionCard;
import io.swagger.client.model.Apiv1tokenizationtransactionOrder;
...
public class TokenizationTransactionBody {
  ...
  @SerializedName("init_token")
  private Integer initToken = null;

  @SerializedName("order")
  private Apiv1tokenizationtransactionOrder order = null;

  @SerializedName("card")
  private Apiv1tokenizationtransactionCard card = null;

  public TokenizationTransactionBody apiOperation(String apiOperation) {
    this.apiOperation = apiOperation;
    return this;
  }

   /**
   * Type of token order (PAY: generate token and include payment if needed or PAY_BY_TOKEN: pay by token generated before)
   * @return apiOperation
  **/
  @Schema(example = "PAY", description = "Type of token order (PAY: generate token and include payment if needed or PAY_BY_TOKEN: pay by token generated before)")
  ...
  public TokenizationTransactionBody merchantId(Integer merchantId) {
   ...
   * @return merchantId
  **/
  @Schema(example = "40002", description = "Merchant ID")
  ...
  public TokenizationTransactionBody initToken(Integer initToken) {
    this.initToken = initToken;
    return this;
  }

   /**
   * Required with api_operation &#x3D; PAY, distinguish orders only generate token or include payment. (1: Only generate token, 0: Include payment)
   * @return initToken
  **/
  @Schema(example = "0", description = "Required with api_operation = PAY, distinguish orders only generate token or include payment. (1: Only generate token, 0: Include payment)")
  public Integer getInitToken() {
    return initToken;
  }

  public void setInitToken(Integer initToken) {
    this.initToken = initToken;
  }

  public TokenizationTransactionBody order(Apiv1tokenizationtransactionOrder order) {
    this.order = order;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public Apiv1tokenizationtransactionOrder getOrder() {
    return order;
  }

  public void setOrder(Apiv1tokenizationtransactionOrder order) {
    this.order = order;
  }

  public TokenizationTransactionBody card(Apiv1tokenizationtransactionCard card) {
    this.card = card;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public Apiv1tokenizationtransactionCard getCard() {
    return card;
  }

  public void setCard(Apiv1tokenizationtransactionCard card) {
    this.card = card;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TokenizationTransactionBody tokenizationTransactionBody = (TokenizationTransactionBody) o;
    return Objects.equals(this.apiOperation, tokenizationTransactionBody.apiOperation) &&
        Objects.equals(this.merchantId, tokenizationTransactionBody.merchantId) &&
        Objects.equals(this.initToken, tokenizationTransactionBody.initToken) &&
        Objects.equals(this.order, tokenizationTransactionBody.order) &&
        Objects.equals(this.card, tokenizationTransactionBody.card);
  }

  @Override
  public int hashCode() {
    return Objects.hash(apiOperation, merchantId, initToken, order, card);
  }
  ...
  public String toString() {
    ...
    sb.append("class TokenizationTransactionBody {\n");
    
    sb.append("    apiOperation: ").append(toIndentedString(apiOperation)).append("\n");
    sb.append("    merchantId: ").append(toIndentedString(merchantId)).append("\n");
    sb.append("    initToken: ").append(toIndentedString(initToken)).append("\n");
