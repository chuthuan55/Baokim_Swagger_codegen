...
public class OrderSendBody {
  ...
  public OrderSendBody mrcOrderId(String mrcOrderId) {
   ...
   * @return mrcOrderId
  **/
  @Schema(description = "Merchant order id")
  ...
  public OrderSendBody totalAmount(Integer totalAmount) {
   ...
   * @return totalAmount
  **/
  @Schema(example = "200000", description = "Order amount")
  ...
  public OrderSendBody description(String description) {
   ...
   * @return description
  **/
  @Schema(example = "test", description = "Order description")
  ...
  public OrderSendBody urlSuccess(String urlSuccess) {
   ...
   * @return urlSuccess
  **/
  @Schema(example = "https://baokim.vn/", description = "URL redirect after payment success")
  ...
  public OrderSendBody merchantId(Integer merchantId) {
   ...
   * @return merchantId
  **/
  @Schema(example = "40002", description = "ID of merchant")
  ...
  public OrderSendBody urlDetail(String urlDetail) {
   ...
   * @return urlDetail
  **/
  @Schema(example = "https://baokim.vn/", description = "Order detail url (redirected when customer cancels order)")
  ...
  public OrderSendBody lang(String lang) {
    this.lang = lang;
    return this;
  }
   ...
   * @return lang
  **/
  @Schema(example = "en", description = "Language (en/vi)")
  ...
  public OrderSendBody bpmId(Integer bpmId) {
    this.bpmId = bpmId;
    return this;
  }
   ...
   * @return bpmId
  **/
  @Schema(example = "128", description = "Bank payment method ID")
  ...
  public OrderSendBody webhooks(String webhooks) {
   ...
   * @return webhooks
  **/
  @Schema(example = "https://baokim.vn/", description = "url is used to send notification to sales website, chat, ... when the payment order is successful, allows notify to multiple urls, separated by commas")
  ...
  public OrderSendBody customerEmail(String customerEmail) {
  ...
  **/
  @Schema(example = "test@gmail.vn", description = "Customer's email")
  ...
  public OrderSendBody customerPhone(String customerPhone) {
  ...
  **/
  @Schema(example = "0888888888", description = "Customer's phone")
  ...
  public OrderSendBody customerName(String customerName) {
   ...
   * @return customerName
  **/
  @Schema(example = "Nguyen Van A", description = "Customer's full name")
  ...
  public OrderSendBody customerAddress(String customerAddress) {
  ...
  **/
  @Schema(example = "102 Thai Thinh", description = "Customer's address")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OrderSendBody orderSendBody = (OrderSendBody) o;
    return Objects.equals(this.mrcOrderId, orderSendBody.mrcOrderId) &&
        Objects.equals(this.totalAmount, orderSendBody.totalAmount) &&
        Objects.equals(this.description, orderSendBody.description) &&
        Objects.equals(this.urlSuccess, orderSendBody.urlSuccess) &&
        Objects.equals(this.merchantId, orderSendBody.merchantId) &&
        Objects.equals(this.urlDetail, orderSendBody.urlDetail) &&
        Objects.equals(this.lang, orderSendBody.lang) &&
        Objects.equals(this.bpmId, orderSendBody.bpmId) &&
        Objects.equals(this.webhooks, orderSendBody.webhooks) &&
        Objects.equals(this.customerEmail, orderSendBody.customerEmail) &&
        Objects.equals(this.customerPhone, orderSendBody.customerPhone) &&
        Objects.equals(this.customerName, orderSendBody.customerName) &&
        Objects.equals(this.customerAddress, orderSendBody.customerAddress);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mrcOrderId, totalAmount, description, urlSuccess, merchantId, urlDetail, lang, bpmId, webhooks, customerEmail, customerPhone, customerName, customerAddress);
  }
