...
public class Apiv1tokenizationtransactionOrder {
  ...
  public Apiv1tokenizationtransactionOrder mrcOrderId(String mrcOrderId) {
  ...
  **/
  ...
  public Apiv1tokenizationtransactionOrder totalAmount(Integer totalAmount) {
    this.totalAmount = totalAmount;
    return this;
  }

   /**
   * Order amount (Not required if api_operation &#x3D; PAY and init_token &#x3D; 1)
   * @return totalAmount
  **/
  @Schema(example = "20000", description = "Order amount (Not required if api_operation = PAY and init_token = 1)")
  ...
  public Apiv1tokenizationtransactionOrder description(String description) {
  ...
  **/
  ...
  public Apiv1tokenizationtransactionOrder urlSuccess(String urlSuccess) {
    this.urlSuccess = urlSuccess;
    return this;
  }

   /**
   * URL redirect when payment success
   * @return urlSuccess
  **/
  @Schema(example = "https://baokim.vn/", description = "URL redirect when payment success")
  ...
  public Apiv1tokenizationtransactionOrder urlDetail(String urlDetail) {
    this.urlDetail = urlDetail;
    return this;
  }

   /**
   * URL redirect when payment failed or canceled
   * @return urlDetail
  **/
  @Schema(example = "https://baokim.vn/", description = "URL redirect when payment failed or canceled")
  ...
  public Apiv1tokenizationtransactionOrder webhooks(String webhooks) {
  ...
  **/
  ...
  public Apiv1tokenizationtransactionOrder customerEmail(String customerEmail) {
  ...
  **/
  @Schema(example = "test@gmail.com", description = "Customer's email")
  ...
  public Apiv1tokenizationtransactionOrder customerPhone(String customerPhone) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Apiv1tokenizationtransactionOrder apiv1tokenizationtransactionOrder = (Apiv1tokenizationtransactionOrder) o;
    return Objects.equals(this.mrcOrderId, apiv1tokenizationtransactionOrder.mrcOrderId) &&
        Objects.equals(this.totalAmount, apiv1tokenizationtransactionOrder.totalAmount) &&
        Objects.equals(this.description, apiv1tokenizationtransactionOrder.description) &&
        Objects.equals(this.urlSuccess, apiv1tokenizationtransactionOrder.urlSuccess) &&
        Objects.equals(this.urlDetail, apiv1tokenizationtransactionOrder.urlDetail) &&
        Objects.equals(this.webhooks, apiv1tokenizationtransactionOrder.webhooks) &&
        Objects.equals(this.customerEmail, apiv1tokenizationtransactionOrder.customerEmail) &&
        Objects.equals(this.customerPhone, apiv1tokenizationtransactionOrder.customerPhone);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mrcOrderId, totalAmount, description, urlSuccess, urlDetail, webhooks, customerEmail, customerPhone);
  }
  ...
  public String toString() {
    ...
    sb.append("class Apiv1tokenizationtransactionOrder {\n");
