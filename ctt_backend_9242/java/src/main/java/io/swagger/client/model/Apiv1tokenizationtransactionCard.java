...
public class Apiv1tokenizationtransactionCard {
  @SerializedName("token")
  private String token = null;

  public Apiv1tokenizationtransactionCard token(String token) {
    this.token = token;
    return this;
  }
   ...
   * @return token
  **/
  @Schema(description = "Token used for payment (Required for api_operation = PAY_BY_TOKEN)")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Apiv1tokenizationtransactionCard apiv1tokenizationtransactionCard = (Apiv1tokenizationtransactionCard) o;
    return Objects.equals(this.token, apiv1tokenizationtransactionCard.token);
  }
